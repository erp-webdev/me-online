<?php
    ...
    if ($logstat) :
        ...
        if ($profile_dbname == "ECINEMA" || $profile_dbname == "EPARKVIEW" || $profile_dbname == "LAFUERZA") :
            $adminarray = array("2011-03-V835", "2015-09-8725", "000015", "2015-11-0550", "2011-12-8558", "2016-04-8756", "2014-10-0004", "2016-06-0457","2017-06-1073","2015-03-0155","2018-08-0483","2019-02-0034","2019-05-0278","2016-04-0268","2019-06-0377","2011-03-V837");
        elseif ($profile_dbname == "CITYLINK" || $profile_dbname == "ECOC" || $profile_dbname == "EREX" || $profile_dbname == "LCTM" || $profile_dbname == "MLI" || $profile_dbname == "NCCAI" || $profile_dbname == "SUNTRUST" || $profile_dbname == "TOWNSQUARE") :
            $adminarray = array("2017-06-1124", "2009-09-V206", "2012-04-U384","2018-07-0406","2007-06-M314","2019-02-0034","2019-03-0123","2018-08-0483","2014-10-0004","2016-04-0268","2019-06-0377","2011-03-V837");
        elseif ($profile_dbname == "FIRSTCENTRO" || $profile_dbname == "MCTI") :
            $adminarray = array("2009-10-V255", "2016-06-0479", "2011-03-V835", "2015-11-0550", "2014-10-0004", "2013-08-N300","2017-06-1073","2007-06-M314","2018-07-0406","2015-03-0155","2018-08-0483","2019-02-0034","2016-04-0268","2019-06-0377","2011-03-V837");
        ...
        elseif ($profile_dbname == "GL" || $profile_dbname == "SIRUS" || $profile_dbname == "ASIAAPMI") :
            $adminarray = array("2014-10-0004", "2014-10-0568", "2016-03-0261", "2017-01-0792", "2011-04-V859", "2015-11-0550", "2016-06-0457", "2018-07-0406","2007-06-M314","2019-02-0034","2019-03-0123","2019-02-0033", "2020-09-0022");
        ...
        $PAYSLIP_MANAGEMENT = [
            'CITYLINK' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483', '2019-05-0278','2016-04-0268','2019-06-0377','2011-03-V837'],
            'ECOC' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483', '2019-05-0278','2016-04-0268','2019-06-0377','2011-03-V837'],
            'ECINEMA' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483', '2019-05-0278','2016-04-0268','2019-06-0377','2011-03-V837'],
            'EPARKVIEW' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483', '2019-05-0278'],
            'EREX' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483', '2019-05-0278','2016-04-0268','2019-06-0377','2011-03-V837'],
            'FIRSTCENTRO' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483', '2019-05-0278','2016-04-0268','2019-06-0377','2011-03-V837'],
            ...
            'LCTM' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483', '2019-05-0278','2016-04-0268','2019-06-0377','2011-03-V837'],
            'MARKETING' => ['1994-03-8275', '2014-10-0004', '2007-06-M314'],
            'MCTI' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483','2016-04-0268','2019-06-0377','2011-03-V837'],
            'MARKETING' => ['1994-03-8275', '2014-10-0004', '2007-06-M314'],
            'MEGAWORLD' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2015-11-0550'],
            'MLI' => ['1994-03-8275', '2014-10-0004', '2007-06-M314'],
            'NCCAI' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483','2016-04-0268','2019-06-0377','2011-03-V837'],
            'NEWTOWN' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483'],
            'SUNTRUST' => ['1994-03-8275', '2014-10-0004', '2007-06-M314', '2018-08-0483', '2019-05-0278','2016-04-0268','2019-06-0377','2011-03-V837'],
