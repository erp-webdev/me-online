<?php
    ...
    if ($logstat) :
        ...
        elseif ($profile_dbname == "GL" || $profile_dbname == "SIRUS" || $profile_dbname == "ASIAAPMI") :
            $adminarray = array("2014-10-0004", "2014-10-0568", "2016-03-0261", "2017-01-0792", "2011-04-V859", "2015-11-0550", "2016-06-0457", "2018-07-0406","2007-06-M314","2019-02-0034","2019-03-0123","2020-09-0022");
