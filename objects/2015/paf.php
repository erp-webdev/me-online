<?php
    ...
    if ($logged == 1 ) {
        ...
        if ($comp == 'GLOBA01' || $comp == 'GLOBAL1' ){ //|| $comp == 'LGMI01' ) {
            ...
            $ratt = "AND (b.DB_NAME = 'MEGAWORLD' OR b.DB_NAME = 'NCCAI' OR b.DB_NAME = 'LCTM' OR b.DB_NAME = 'MLI' OR b.DB_NAME = 'TOWNSQUARE' OR b.DB_NAME = 'SUNTRUST' OR b.DB_NAME = 'FIRSTCENTRO' OR b.DB_NAME = 'EREX' OR b.DB_NAME = 'EPARKVIEW' OR b.DB_NAME = 'ECOC' OR b.DB_NAME = 'ECINEMA' OR b.DB_NAME = 'CITYLINK' OR DBNAME = 'SIRUS' OR DBNAME = 'ASIAAPMI' OR DBNAME = 'LAFUERZA') ";

            $rattkev = "AND (DBNAME = 'MEGAWORLD' OR DBNAME = 'NCCAI' OR DBNAME = 'LCTM' OR DBNAME = 'MLI' OR DBNAME = 'TOWNSQUARE' OR DBNAME = 'SUNTRUST' OR DBNAME = 'FIRSTCENTRO' OR DBNAME = 'EREX' OR DBNAME = 'EPARKVIEW' OR DBNAME = 'ECOC' OR DBNAME = 'ECINEMA' OR DBNAME = 'CITYLINK' OR DBNAME = 'SIRUS' OR DBNAME = 'ASIAAPMI' OR DBNAME = 'MREIT' OR DBNAME = 'MCTI' OR DBNAME = 'LAFUERZA') ";
        }
