<?php
	...
	if ($profile_dbname != 'EPARKVIEW' && $profile_dbname != 'NEWTOWN') {
        ...
        if ($comp == 'GLOBA01' || $comp == 'GLOBAL1' ){ //|| $comp == 'LGMI01' ) {
            ...
            $rattkev = "AND (DBNAME = 'MEGAWORLD' OR DBNAME = 'NCCAI' OR DBNAME = 'LCTM' OR DBNAME = 'MLI' OR DBNAME = 'TOWNSQUARE' OR DBNAME = 'SUNTRUST' OR DBNAME = 'FIRSTCENTRO' OR DBNAME = 'EREX' OR DBNAME = 'EPARKVIEW' OR DBNAME = 'ECOC' OR DBNAME = 'ECINEMA' OR DBNAME = 'CITYLINK' OR DBNAME = 'SIRUS' OR DBNAME = 'ASIAAPMI' OR DBNAME = 'MREIT' OR DBNAME = 'MCTI') ";
        }
