<?php
	...
	if ($logged == 1 
            && $profile_dbname != 'ECINEMA' 
            && $profile_dbname != 'EPARKVIEW' 
            && $profile_dbname != 'NEWTOWN'
             && $profile_dbname != 'LAFUERZA')  {
            ...
            if($_POST['memo_title']) : 
                ...
                if ($memo_db) :
                    ...
                    foreach ($receivers as $key => $value) :
                        ...
                        $message = "<div style='display: block; border: 5px solid #024485; padding: 10px; font-size: 12px; font-family: Verdana; width: 100%;'><span style='font-size: 18px; color: #024485; font-weight: bold;'>New ME Online Memo Published</span><br><br>Hi ".$value['FullName'].",<br><br>";
