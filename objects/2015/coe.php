<?php
	...
	if ($logged == 1) {
		...
		if(!(in_array($profile_dbname, ['ASIAAPMI', 'CITYLINK', 'ECOC', 'ECINEMA', 'EREX', 'LAFUERZA', 'LCTM', 'GL', 'MEGAWORLD', 'MLI', 'MCTI', 'NCCAI', 'SIRUS', 'SUNTRUST', 'TOWNSQUARE', 'MREIT', 'NEWTOWN', 'GLOBAL_HOTEL', 'Rowenta', 'MEGAPARK']))){
