<?php
    ...
    if (($last_notify != date("Y-m-d") || !$last_notify) && $profile_level == 7) :
        ...
        foreach ($receivers as $key => $value) :
            ...
            if ($value['EmailAdd']) :
                if ($value['DBNAME'] == 'GL') :     
                    $appendmail = $mails->mail_cue('meonline-bday-noreply@alias.megaworldcorp.com', $value['EmailAdd'], "Happy Birthday to you!", $message, $headers, 'hrportal@megaworldcorp.com');
                else :
                    $appendmail = $mails->mail_cue('meonline-bday-noreply@alias.megaworldcorp.com', $value['EmailAdd'], "Happy Birthday to you!", $message, $headers, 'hrportal@megaworldcorp.com');
                endif;
        ...
        if ($mailcount) :
            echo "<script>alert('Birthday card has been successfully sent to ".$mailcount." birthday celebrant')</script>";  
        endif;
