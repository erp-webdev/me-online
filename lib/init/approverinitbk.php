    ...
    foreach($approvers as $key => $value) :
        ...
        if ($value['TYPE'] == 'frmApplicationLVWeb') :
            if ($value['SIGNATORYID1'] || $value['SIGNATORYID2'] || $value['SIGNATORYID3'] || $value['SIGNATORYID4'] || $value['SIGNATORYID5'] || $value['SIGNATORYID6']) :
                $lv_app = array(1 => array(0 => $value['SIGNATORY1'], 1 => $value['SIGNATORYID1'], 2 => $value['SIGNATORYDB1']), 
                                2 => array(0 => $value['SIGNATORY2'], 1 => $value['SIGNATORYID2'], 2 => $value['SIGNATORYDB2']), 
                                3 => array(0 => $value['SIGNATORY3'], 1 => $value['SIGNATORYID3'], 2 => $value['SIGNATORYDB3']), 
                                4 => array(0 => $value['SIGNATORY4'], 1 => $value['SIGNATORYID4'], 2 => $value['SIGNATORYDB4']), 
                                5 => array(0 => $value['SIGNATORY5'], 1 => $value['SIGNATORYID5'], 2 => $value['SIGNATORYDB5']), 
                                6 => array(0 => $value['SIGNATORY6'], 1 => $value['SIGNATORYID6'], 2 => $value['SIGNATORYDB6'])
                               );
            else :
                $lv_app = NULL;
            endif;
        elseif ($value['TYPE'] == 'frmApplicationOTWeb') :
            if ($value['SIGNATORYID1'] || $value['SIGNATORYID2'] || $value['SIGNATORYID3'] || $value['SIGNATORYID4'] || $value['SIGNATORYID5'] || $value['SIGNATORYID6']) :
                $ot_app = array(1 => array(0 => $value['SIGNATORY1'], 1 => $value['SIGNATORYID1'], 2 => $value['SIGNATORYDB1']), 
                                2 => array(0 => $value['SIGNATORY2'], 1 => $value['SIGNATORYID2'], 2 => $value['SIGNATORYDB2']), 
                                3 => array(0 => $value['SIGNATORY3'], 1 => $value['SIGNATORYID3'], 2 => $value['SIGNATORYDB3']), 
                                4 => array(0 => $value['SIGNATORY4'], 1 => $value['SIGNATORYID4'], 2 => $value['SIGNATORYDB4']), 
                                5 => array(0 => $value['SIGNATORY5'], 1 => $value['SIGNATORYID5'], 2 => $value['SIGNATORYDB5']), 
        ...
        elseif ($value['TYPE'] == 'frmApplicationOBWeb') :
            if ($value['SIGNATORYID1'] || $value['SIGNATORYID2'] || $value['SIGNATORYID3'] || $value['SIGNATORYID4'] || $value['SIGNATORYID5'] || $value['SIGNATORYID6']) :
                $ob_app = array(1 => array(0 => $value['SIGNATORY1'], 1 => $value['SIGNATORYID1'], 2 => $value['SIGNATORYDB1']), 
                                2 => array(0 => $value['SIGNATORY2'], 1 => $value['SIGNATORYID2'], 2 => $value['SIGNATORYDB2']), 
                                3 => array(0 => $value['SIGNATORY3'], 1 => $value['SIGNATORYID3'], 2 => $value['SIGNATORYDB3']), 
                                4 => array(0 => $value['SIGNATORY4'], 1 => $value['SIGNATORYID4'], 2 => $value['SIGNATORYDB4']), 
                                5 => array(0 => $value['SIGNATORY5'], 1 => $value['SIGNATORYID5'], 2 => $value['SIGNATORYDB5']), 
        ...
        elseif ($value['TYPE'] == 'frmApplicationMDWeb') :
            if ($value['SIGNATORYID1'] || $value['SIGNATORYID2'] || $value['SIGNATORYID3'] || $value['SIGNATORYID4'] || $value['SIGNATORYID5'] || $value['SIGNATORYID6']) :
                $md_app = array(1 => array(0 => $value['SIGNATORY1'], 1 => $value['SIGNATORYID1'], 2 => $value['SIGNATORYDB1']), 
                                2 => array(0 => $value['SIGNATORY2'], 1 => $value['SIGNATORYID2'], 2 => $value['SIGNATORYDB2']), 
                                3 => array(0 => $value['SIGNATORY3'], 1 => $value['SIGNATORYID3'], 2 => $value['SIGNATORYDB3']), 
                                4 => array(0 => $value['SIGNATORY4'], 1 => $value['SIGNATORYID4'], 2 => $value['SIGNATORYDB4']), 
                                5 => array(0 => $value['SIGNATORY5'], 1 => $value['SIGNATORYID5'], 2 => $value['SIGNATORYDB5']), 
        ...
        elseif ($value['TYPE'] == 'frmApplicationSCWeb') :
            if ($value['SIGNATORYID1'] || $value['SIGNATORYID2'] || $value['SIGNATORYID3'] || $value['SIGNATORYID4'] || $value['SIGNATORYID5'] || $value['SIGNATORYID6']) :
                $sc_app = array(1 => array(0 => $value['SIGNATORY1'], 1 => $value['SIGNATORYID1'], 2 => $value['SIGNATORYDB1']), 
                                2 => array(0 => $value['SIGNATORY2'], 1 => $value['SIGNATORYID2'], 2 => $value['SIGNATORYDB2']), 
                                3 => array(0 => $value['SIGNATORY3'], 1 => $value['SIGNATORYID3'], 2 => $value['SIGNATORYDB3']), 
                                4 => array(0 => $value['SIGNATORY4'], 1 => $value['SIGNATORYID4'], 2 => $value['SIGNATORYDB4']), 
                                5 => array(0 => $value['SIGNATORY5'], 1 => $value['SIGNATORYID5'], 2 => $value['SIGNATORYDB5']), 
        ...
        elseif ($value['TYPE'] == 'frmApplicationMAWeb') :
            if ($value['SIGNATORYID1'] || $value['SIGNATORYID2'] || $value['SIGNATORYID3'] || $value['SIGNATORYID4'] || $value['SIGNATORYID5'] || $value['SIGNATORYID6']) :
                $ma_app = array(1 => array(0 => $value['SIGNATORY1'], 1 => $value['SIGNATORYID1'], 2 => $value['SIGNATORYDB1']), 
                                2 => array(0 => $value['SIGNATORY2'], 1 => $value['SIGNATORYID2'], 2 => $value['SIGNATORYDB2']), 
                                3 => array(0 => $value['SIGNATORY3'], 1 => $value['SIGNATORYID3'], 2 => $value['SIGNATORYDB3']), 
                                4 => array(0 => $value['SIGNATORY4'], 1 => $value['SIGNATORYID4'], 2 => $value['SIGNATORYDB4']), 
                                5 => array(0 => $value['SIGNATORY5'], 1 => $value['SIGNATORYID5'], 2 => $value['SIGNATORYDB5']), 
        ...
        elseif ($value['TYPE'] == 'frmApplicationNPWeb') :
            if ($value['SIGNATORYID1'] || $value['SIGNATORYID2'] || $value['SIGNATORYID3'] || $value['SIGNATORYID4'] || $value['SIGNATORYID5'] || $value['SIGNATORYID6']) :
                $np_app = array(1 => array(0 => $value['SIGNATORY1'], 1 => $value['SIGNATORYID1'], 2 => $value['SIGNATORYDB1']), 
                                2 => array(0 => $value['SIGNATORY2'], 1 => $value['SIGNATORYID2'], 2 => $value['SIGNATORYDB2']), 
                                3 => array(0 => $value['SIGNATORY3'], 1 => $value['SIGNATORYID3'], 2 => $value['SIGNATORYDB3']), 
                                4 => array(0 => $value['SIGNATORY4'], 1 => $value['SIGNATORYID4'], 2 => $value['SIGNATORYDB4']), 
                                5 => array(0 => $value['SIGNATORY5'], 1 => $value['SIGNATORYID5'], 2 => $value['SIGNATORYDB5']), 
