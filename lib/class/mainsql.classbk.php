...
class mainsql {
    ...
    function get_altapprovers($empid, $count = 0)
	{
		$sql = "SELECT DISTINCT DocType, ToUserID, UserID FROM ApprovalAlternative WHERE EMPID = '".$empid."' AND (GETDATE() BETWEEN FromDate AND ToDate) AND (DocType = 'frmApplicationLVWeb' OR DocType = 'frmApplicationOTWeb' OR DocType = 'frmApplicationOBWeb' OR DocType = 'frmApplicationMDWeb' OR DocType = 'frmApplicationNPWeb' OR DocType = 'frmApplicationSCWeb')   ";
		if ($count) : $result = $this->get_numrow($sql);			
        else : $result = $this->get_row($sql);			
        endif;
		return $result;
    ...
    function get_dept_data($id = 0)
    {   
        
        $sql = "SELECT * FROM HRDepartment ";
        if ($id != 0) : $sql .= " WHERE DeptID = '".$id."'"; endif;
    ...
    function get_newemailblock($empid)
	{
    ...
    function get_appemailblock($empid)
	{
    ...
    function set_emailblock($empid, $value = 0, $new = 0)
	{
    ...
    function set_psblock($empid, $value = 0)
	{
    ...
    function get_attachments($empid = NULL, $count = 0)
	{
	...
	{
		$sql = "SELECT LeaveID, EarnedDays, UsedDays, BalanceDays FROM HREmpLBalance WHERE EmpID = '".$empid."' AND LeaveID = '".$leaveid."' AND DateEffect <= GETDATE() ";
		$result = $this->get_row($sql);			
		return $result;
	}  
    ...
    function get_memo($id = 0, $start = 0, $limit = 0, $search = NULL, $count = 0, $from = 0, $to = 0)
	{
    ...
    function get_leavedata($leaveref = NULL)
    {
        ...
        if ($leaveref != NULL) : $sql .= " WHERE LeaveRef = '".$leaveref."' "; endif;
		$result = $this->get_row($sql);			
		return $result;
    }
    ...
    {
        $sql = "SELECT ObTimeInDate, ObTimeOutDate, Status FROM HRFrmApplyNoticeOfficialBusinessItem ";
    ...
    function get_otdata_applied($idnum, $from, $to)
    {
        ...
        $sql .= " (SELECT Reference FROM TED_VIEW_NOTIFICATION WHERE EmpID ='".$idnum."' ";
        $sql .= " AND Approved IN (0,1)) ";
        $sql .= " AND FromDate BETWEEN '".$from." 00:00:00.000' AND '".$to." 23:59:59.000' ";
		$result = $this->get_numrow($sql);			
		return $result;
    }
    ...
    function get_dtr_period($year, $company, $all = 0)
	{
        $numbdays = date("j");
	...
	{
		$sql = "SELECT OD01, OD02, OD03, OD04, OD05, OD06, OD07, OD08, OD09, OD10, OD11, OD12, OD13, OD14, OD15, OD16, OD17, OD18, OD19, OD20, OD21, OD22, OD23, OD24, OD25, OD26, OD27, OD28, OD29, OD30, OD31, OD32, OD33, OD34, OD35, OD36, OD37, OD38, OD39, OD40, OD41, OD42, OD43, OD44, OD45, OD46, OD47, OD48, OD49, OD50 FROM PRSummaryExtH ";
        $sql .= " WHERE EmpID = '".$empid."' ";
        $sql .= " AND PRYear = '".$year."' AND PeriodID = '".$pr."' ";
		$result = $this->get_row($sql);			
		return $result;
	...
	{
		$sql = "SELECT ShiftID, ShiftDesc, TimeIN, TimeOut, CreditTimeIN, CreditTimeOut 
            FROM viewHRDTR
	...
	{
		$sql = "SELECT ShiftID, ShiftDesc, TimeIN, TimeOUT, NUMHrs, BreakHours
            FROM HRShift ";
        if ($shiftid != NULL) : $sql .= " WHERE ShiftID = '".$shiftid."' "; endif;
		$result = $this->get_row($sql);			
		return $result;
    } 
    ...
    function approver_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
			...
			case 'update':
                ...
                $accepted_field = array('EMPID', 'TYPE', 'SIGNATORYID01', 'SIGNATORYID02', 'SIGNATORYID03', 'SIGNATORYID04', 'SIGNATORYID05', 'SIGNATORYID06', 'ALTID01', 'ALTID02', 'ALTID03', 'ALTID04', 'ALTID05', 'ALTID06');
                ...
                $update_appr = $this->get_sp_data('INSERTAPPROVER', $val);
    ...
    function memo_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
			case 'add':
                ...
                $accepted_field = array('memo_title', 'memo_attach', 'memo_attachtype', 'memo_date', 'memo_user', 'memo_status');
    ...
    function leave_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
            ...
            case 'add_item':
                ...
                $accepted_field = array('REQNBR', 'DURATION', 'LEAVEDATE', 'WITHPAY');
            ...
            case 'approve':
                ...
                $approve_leave = $this->get_sp_data('SP_INSERT_APPLY_LV', $val);
    ...
    function ot_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
			case 'add':
                ...
                $accepted_field = array('EMPID', 'REQNBR', 'TRANS', 'APLYHRS', 'APPROVEDHRS', 'FROMDATE', 'TODATE', 'DTRDATE', 'REASON', 'OTTYPE', 'APPROVER01', 'APPROVER02', 'APPROVER03', 'APPROVER04', 'APPROVER05', 'APPROVER06', 'USER', 'REMARKS');
            ...
            case 'approve':
                ...
                $approve_ot = $this->get_sp_data('SP_INSERT_APPLY_OT', $val);
    ...
    function ob_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
			case 'add':
                ...
                $accepted_field = array('EMPID', 'REQNBR', 'TRANS', 'OBTIMEINDATE', 'OBTIMEOUTDATE', 'DAYS', 'DESTINATION', 'REASON', 'APPROVER01', 'APPROVER02', 'APPROVER03', 'APPROVER04', 'APPROVER05', 'APPROVER06', 'USER', 'REMARKS');
            ...
            case 'add_item':
                ...
                $accepted_field = array('REQNBR', 'OBTIMEINDATE', 'OBTIMEOUTDATE');
            ...
            case 'approve':
                ...
                $approve_ob = $this->get_sp_data('SP_INSERT_APPLY_OBT', $val);
    ...
    function md_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
			case 'add':
                ...
                $accepted_field = array('EMPID', 'REQNBR', 'TRANS', 'DATESTART', 'APPROVER01', 'APPROVER02', 'APPROVER03', 'APPROVER04', 'APPROVER05', 'APPROVER06', 'USER', 'REMARKS');
            ...
            case 'approve':
                ...
                $approve_md = $this->get_sp_data('SP_INSERT_APPLY_MD', $val);
    ...
    function np_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
			case 'add':
                ...
                $accepted_field = array('EMPID', 'REQNBR', 'TRANS', 'TIMEIN', 'TIMEOUT', 'DATEIN', 'DATEOUT', 'REASON', 'APPROVER01', 'APPROVER02', 'APPROVER03', 'APPROVER04', 'APPROVER05', 'APPROVER06', 'USER', 'REMARKS');
            ...
            case 'approve':
                ...
                $approve_np = $this->get_sp_data('SP_INSERT_APPLY_NPA', $val);
    ...
    function sc_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
            ...
            case 'approve':
                ...
                $approve_sc = $this->get_sp_data('SP_INSERT_APPLY_SC', $val);
    ...
    function ts_action($value, $action, $id = 0)
	{
		...
		switch ($action) {
            ...
            case 'approve':
                ...
                $approve_ts = $this->get_sp_data('SP_INSERT_APPLY_TS', $val);
