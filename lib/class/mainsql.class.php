...
class mainsql {
    ...
    {
      $sql = "SELECT SHIFT, SUBSTRING(CAST(STARTTIME as varchar), 1, 2) as STARTTIME, SUBSTRING(CAST(ENDTIME as varchar), 1, 2) as ENDTIME, NUMHRS FROM FN_GETSHIFT('".$empid."', '".$date."')";
      $result = $this->get_row($sql);
