    ...
    <!-- BODY -->
                    ...
                    <div id="floatdiv" class="floatdiv invisible">
                                        ...
                                        <form name="regis_act" id="regis_act" action="?ignore-page-cache=true" method="POST" enctype="multipart/form-data">
                                            <table class="width100per">
                                                ...
                                                <tr id="location">
                                                    ...
                                                    <td>
                                                        ...
                                                        <select id="registry_location" name="registry_location" class="txtbox" required>
                                                            <?php /* <option value="Uptown Cinemas" <?php echo $locations['uptown'] >= $reserved_slots['uptown'] ? 'disabled' : '' ?> slots="<?php echo $reserved_slots['uptown']; ?>" reserved="<?php echo $locations['uptown']; ?>">Uptown Cinemas <?php echo $locations['uptown'] >= $reserved_slots['uptown'] ? '(Full)' : '' ?></option> */?>
                                                            <?php /* <option value="Eastwood Cinemas" <?php echo $locations['eastwood'] >= $reserved_slots['eastwood'] ? 'disabled' : '' ?> slots="<?php echo $reserved_slots['eastwood']; ?>" reserved="<?php echo $locations['eastwood']; ?>">Eastwood Cinemas  <?php echo $locations['eastwood'] >= $reserved_slots['eastwood'] ? '(Full)' : '' ?></option>*/?>
                                                ...
                                                <tr id="vaxcert">
                                                    ...
                                                    <td>
                                                        <input type="file" name="registry_vaxcert" id="registry_vaxcert" class="txtbox width200" class="txtbox" required/><br /><i>* must be image (jpg, jpeg, gif, png) and less than or equal 2Mb</i>
                                                    </td>
                                                </tr>
                                                <tr id="vaxstatus">
                                                    <td><b>Vaccination Status</b></td>
                                                    <td>
                                                        <select name="registry_vaxstatus" id="registry_vaxstatus" class="txtbox" required>
                                                ...
                                                <tr id="vaxcert">
                                                    ...
                                                    <td>
                                                        <input type="date" name="registry_vaxlastdate" id="registry_vaxlastdate" class="txtbox width200" class="txtbox" required/>
                                                    </td>
                                                </tr>
                                                <?PHP endif; ?>
                                                ...
                                                <tr id="godir">
                                                    ...
                                                    <td>
                                                        <select id="registry_godirectly" name="registry_godirectly" class="txtbox" required>
                                            ...
                                            <table id="godirno" class="width100per invisible">
                                                <tr>
                                                    ...
                                                    <td width="65%">From <span class="pickupfrom"></span> To <span class="placedata"></span></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input id="registry_vrout" type="checkbox" name="registry_vrout" />
                                                    </td>
                                                    <td>From <span class="placedata"></span> To <span class="pickupfrom"></span></td>
                                                </tr>
                                            </table>
                                            ...
                                            */ ?>
                                            ...
                                            <div class="width100per margintop25 centertalign">
                                                ...
                                                <p>
                                                By submitting this form, I hereby waive and render Megaworld and its officers, employees and representatives free and harmless from any claim, action and/or liability arising from in any manner related to our attendance and participation in the Event
                                                </p>
                                                <?php else: ?>
                                                <p>By submitting this form, I hereby waive and render Global Companies and its officers, employees and representatives free and harmless from any claim, action and/or liability arising from in any manner related to our attendance and participation in the Event</p>
                                                <?php endif; ?>
                        ...
                        <?php if ($accessman->hasAccess($profile_idnum, $profile_comp, $profile_dbname, 'activities')) : ?>
