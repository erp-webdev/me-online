    ...
    <!-- BODY -->
                    ...
                    <div id="floatdiv" class="floatdiv invisible">
                        <?php if ($accessman->hasAccess($profile_idnum, $profile_comp, $profile_dbname, 'memo')) : ?>
                        <!-- CREATE MEMO - BEGIN -->
                                ...
                                <table border="0" cellspacing="0" class="tdata width100per margintop25">
                                    ...
                                    <tr class="trdata centertalign">
                                        <td width="30%"<?php if ($key == 0) : ?> class="topborder"<?php endif; ?>>
                                            ...
                                            <!-- <a href="<?php echo WEB; ?>/lib/requests/download.php?file=<?php echo $value['announce_filename']; ?>" target="_blank"> -->
