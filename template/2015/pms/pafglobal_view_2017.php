                ...
                <?php $rtrstat = 'Approved'; $dhstat = 1; if($sub == 1 && $rstat1 == 1){ $param1 = 1; } elseif($sub == 2 && $rstat2 == 1) { $param1 = 1; } elseif($sub == 3 && $rstat3 == 1) { $param1 = 1; } elseif($sub == 4 && $rstat4 == 1) { $param1 = 1; } else { $param1 = 0; } ?>
                    ...
                    <hr></hr>
                        ...
                        <div style="border:2px solid #fff;padding-left:5px;width:98%;">
                            <p><strong>Use the following rating scale for each relevant part of this form (half points allowed):</strong></p>
                            <table>
                                <tr>
                                    <td>5</td>
                                    <td>Exceptional</td>
                    ...
                    <?php if ($pafad == 'rater' && $rtrstat == 'Approved' && $dhstat != $param1) { ?>
                        ...
                        <?php if(count($checkWResults) > 0) { ?>
                            ...
                            <div style="border:1px solid #fff;padding-left:5px;padding-right:5px;width:98%;">
                                ...
                                <div class="work-result-wrapper">
                                    ...
                                    <div style="float:left;width:380px;">
                                        <div style="float:left;width:380px;">
                                            <p><textarea style="display:none;" name="wrp3obj[]"><?php echo $row['wrobj']; ?></textarea><?php echo $row['wrobj']; ?></p><br><span style=""><strong>Measurement of Accomplisment: </strong><?php echo $row['MOA']; ?></span>
                                        </div>
                                    </div>
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function(){
                                       ...
                                       function fnAlltotal(){
                                             ...
                                             var pccgtotal = pcctotal.toFixed(2);
                            ...
                            <script type="text/javascript">
                             ...
                             <?php foreach($checkEvaluation AS $row) { ?>
                                <?php 
                                    if($row['cmscore'] != NULL && $row['apscore'] != NULL){ 
                                    $cmscore = $row['cmscore'] * 0.15;
                                    $apscore = $row['apscore'] * 0.10;
                                ?>
                                ...
                                <table style="border:1px solid #fff;width:99.6%;">
                                    <thead>
                                    <tr>
                                        <th style="text-align:left;width:350px;">A. HR RELATED EVALUATION - 40%</th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;border-top:1px solid #fff;"><?php echo $ffinal1 = $cmscore + $apscore; ?></td>
                                    </tr>
                                </table>
                                ...
                                <table style="border:1px solid #fff;width:99%;">
                                    <thead>
                                    <tr>
                                        <th style="text-align:left;width:350px;">B. PERFORMANCE EVALUATION - 60%</th>
                                        <th style="text-align:center;">% Value</th>
                                        <th style="text-align:center;">Rate</th>
                                        <th style="text-align:center;">Final Value</th>
                                    </tr>
                            ...
                            <div style="border:1px solid #fff;padding-left:5px;width:98.6%;">
                                ...
                                <p><textarea name="remarks" class="remarks perfsummary checker" style="width:98.4%;min-height:100px;"><?php echo nl2br($rcomm1).($flashRater > 1 && $rcomm2 ? '.&#13;&#10;.&#13;&#10;'.nl2br($rcomm2) : '').($flashRater > 2 && $rcomm3 ? '.&#13;&#10;.&#13;&#10;'.nl2br($rcomm3) : '').($flashRater > 3 && $rcomm4 ? '.&#13;&#10;.&#13;&#10;'.nl2br($rcomm4) : ''); ?></textarea></p>
                            </div><!-- End of part 2 -->
                            <br />
                            ...
                            <?php if($max1i == 1) { ?>
                                ...
                                Promotion To: <input type="text" name="promotion" value="<?php echo $rprom; ?>">&nbsp;&nbsp;&nbsp;
                                Salary Increase: <input type="number" min="1" max="100" name="increase" value="<?php echo $rincr; ?>">%
                                <br /><br />
                            <?php } else { ?>
                        ...
                        <?php if(count($checkWResults) > 0) { ?>
                            ...
                            <div style="border:1px solid #fff;padding-left:5px;padding-right:5px;width:98%;">
                                ...
                                <div class="work-result-wrapper">
                                    ...
                                    <div style="float:left;width:380px;">
                                        <div style="float:left;width:380px;">
                                            <p><textarea style="display:none;" name="wrp3obj[]"><?php echo $row['wrobj']; ?></textarea><?php echo $row['wrobj']; ?></p></p><br><span style=""><strong>Measurement of Accomplisment: </strong><?php echo $row['MOA']; ?>
                                        </div>
                                    </div>
                            ...
                            <div style="border:1px solid #fff;padding-left:5px;width:98.6%;">
                                <h4>VI. PERFORMANCE SUMMARY <span style="font-size:10px;font-weight:normal;">(Written by Reviewing Manager)</span></h4>
                                <p><textarea name="remarks" class="remarks perfsummary checker" style="width:98.4%;min-height:100px;" readonly><?php echo nl2br($rcomm1).($flashRater > 1 && $rcomm2 ? '.&#13;&#10;.&#13;&#10;'.nl2br($rcomm2) : '').($flashRater > 2 && $rcomm3 ? '.&#13;&#10;.&#13;&#10;'.nl2br($rcomm3) : '').($flashRater > 3 && $rcomm4 ? '.&#13;&#10;.&#13;&#10;'.nl2br($rcomm4) : ''); ?></textarea></p>
                            </div><!-- End of part 2 -->
                            <?php if($max1i == 1) { ?>
                                <!--h3><strong>Equivalent system generated percentage increase: </strong> <?php echo $finincrease * .10.'%'; ?></h3>-->
                                <p><strong>Final Recommendation;</strong> please fill up your desired recommendations below. This will override system generated percentage for salary increase.</p>
                                Promotion To: <input type="text" name="promotion" value="<?php echo $rprom; ?>" readonly>&nbsp;&nbsp;&nbsp;
                                Salary Increase: <input type="text" min="1" max="100" name="increase" value="<?php echo $rincr; ?>" readonly>%
                                <br /><br />
                            <?php } else { ?>
                                <input type="hidden" name="increase" value="">
                                <input type="hidden" name="promotion" value="">
                                ...
                                <table style="border:1px solid #fff;width:99.6%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;border-top:1px solid #fff;">
                                            <?php echo $ffinal1 = $cmscore + $apscore; ?>
                                        </td>
                                    </tr>
                                </table>
                                <?php // if($checkifsave == 2) { ?>
