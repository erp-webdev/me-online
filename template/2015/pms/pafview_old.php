                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] == 5) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-up"></i>) This Employee is Exceptional'; $color1 = '#06A716'; } ?>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] < 5 && $row['computed'] >= 4) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-up"></i>) This Employee Exceeds Expectations'; $color1 = '#06A716'; } ?>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] < 4 && $row['computed'] >= 3) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-up"></i>) This Employee Meets Expectations'; $color1 = '#06A716'; } ?>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] < 3 && $row['computed'] >= 2) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-up"></i>) This Employee Needs Improvement'; $color1 = '#06A716'; } ?>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] < 2 && $row['computed'] >= 1) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-down"></i>) This Employee has No Evidence of Skill'; $color1 = '#A70606'; } ?>
                                        </td>
                            ...
                            <?php foreach($checkEvaluation AS $row) { ?>
                                ...
                                <table style="border:2px solid #fff;width:99%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><?php $gfx2 = $ffx2 * 0.4; echo $fin2 = number_format((float)$gfx2, 2, '.', ''); ?><input type="hidden" name="apscore" class="boxPom" value="<?php echo $apscore; ?>"><input type="hidden" name="s5score" class="boxPom" value="<?php echo $s5score; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td style="text-align:center;"></td>
                                        <td style="text-align:right;font-weight:bold;">Total:</td>
                                        <td style="text-align:center;border-top:1px solid #fff;"><?php echo $final2 = $fin1 + $fin2 ?></td>
                                    </tr>
                                    ...
                                    <?php if ($pafad == 'rater' && $rtrstat == 'Approved' && $dhstat != $param1) { ?>
                                        <?php if($sub == $i) { ?>
                                            ...
                                            <?php if($max1i == 1) { ?>
                                                ...
                                                Promotion To: <input type="text" name="promotion">&nbsp;&nbsp;&nbsp;
                                                Salary Increase: <input type="number" min="1" max="100" name="increase">%
                                                <br /><br />
                                            <?php } else { ?>
                        ...
                        <div style="overflow-y:scroll;max-height:514px;margin-top:10px;">
                            ...
                            <table style="width:100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><b class="smallesttext lwhitetext">Period:</b> <span style="font-weight:normal;">From | <u><?php echo '2015-01-01'; // echo date('Y-m-d', strtotime($row['dtfrom'])); ?></u> To | <u><?php echo '2015-01-30';// echo date('Y-m-d', strtotime($row['dtto'])); ?></u></span></td>
                                    ...
                                    <tr>
                                        <td width="21%;">
                                            <p style="font-size:10px;">
                                                <!--<b>Overall Rating <span style="font-size:9px;">(Based on Parts I and II)</span></b><br />-->
                                                Conduct/Memo = 15%<br />
                                                Staff Member's Competencies = 15%<br />
                                                Performance Goals           = 70%<br />
                                                <!--(Please check one of the appropriate box)-->
                                            </p>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] == 5) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-up"></i>) According to your rating you are Exceptional.'; $color1 = '#06A716'; } ?>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] < 5 && $row['computed'] >= 4) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-up"></i>) According to your rating you Exceeds Expectations.'; $color1 = '#06A716'; } ?>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] < 4 && $row['computed'] >= 3) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-up"></i>) According to your rating you Meets Expectations.'; $color1 = '#06A716'; } ?>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] < 3 && $row['computed'] >= 2) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-up"></i>) According to your rating you still Need Improvements.'; $color1 = '#06A716'; } ?>
                                        </td>
                                        <td width="5%;" style="text-align:center;">
                                            <?php if($row['computed'] < 2 && $row['computed'] >= 1) { ?> <i class="fa fa-check"></i> <?php $note1 = '(<i class="fa fa-thumbs-down"></i>) According to your rating you have No Evidence of Skills'; $color1 = '#A70606'; } ?>
                                        </td>
                                        <td width="20%;" style="text-align:center;">
                                            <?php echo nl2br($row['orcomm']); ?>
                                        </td>
