                            ...
                            <table id="comass" border="0" cellspacing="0" class="tdata" style="width:99%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row['Type'] == 'CORE') : ?>
                                        <br><i class="jobdesc-btn" style="cursor: pointer"> Click to see descirption </i>
                                    ...
                                    <td style="text-align:left;">
                                       ...
                                       <?php if($rankid == 'RFP' && $row['Type'] == 'CORE') { ?>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <textarea name="caRemarksr[]" id="" cols="20" rows="2" placeholder="Add your remarks"  class="checker"><?php echo $row['Remarks']; ?></textarea>
                            ...
                            <script type="text/javascript">
                                $(document).ready(function(){
                                    ...
                                    newTextBoxDiv.after().html(
                                        ...
                                        '<tr>' +
                                            '<td style="text-align:center;">' +
                                                '<textarea name="g2Title1[]" class="checker" cols="40" rows="3" required></textarea>' +
                                            '</td>' +
                                            '<td style="text-align:center;">' +
                            ...
                            <script type="text/javascript">
                                $(document).ready(function(){
                                    ...
                                    newTextBoxDiv.after().html('<tr>' +
                                        '<td style="text-align:center;">' +
                                            '<textarea name="g3Title1[]" class="checker" cols="40" rows="3" required></textarea>' +
                                        '</td>' +
                                        '<td style="text-align:center;">' +
                                    ...
                                    <?php //if ($pafad == 'rater' && $rtrstat == 'Approved' && $dhstat != $param1) { ?>
                                        <?php if($sub == $i) { ?>
                                            <!--<input type="file" class="width25 smltxtbox" id="upfile1" style="display:none;float:left;marign-right:5px;margin-top:-2.5px;" name="upfile" />-->
                                                <h3 style=""><strong>Equivalent system generated percentage increase: </strong> <span id="incVa">

                                                    <?php

                                                        $inc = $row['Increase'];
                                                        if(trim($row['promote']) != $row['randesc'] && !empty(trim($row['promote'])) && trim($row['promote']) != 'NOT FOR PROMOTION'){
                                                            $inc = $row['Proincrease'];
                                                        }
                                                            ...
                                                            <table class="tdataform2 rightmargin margintop10 vsmalltext" width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <th style="vertical-align:top;"><?php echo $row['randesc']; ?></th>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th style="vertical-align:top;"><?php echo empty(trim($row['rprom' . ($i-1)])) ? 'No recommendation' : $row['rprom' . ($i-1)]; ?></th>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <th style="vertical-align:top;">
                                                                            <select id="finalrank" class="txtbox width95per">
                                                                                ...
                                                                                <option value="<?php echo $rank; ?>" <?php echo $row['promote'] == $rank ? 'selected' : ''; ?>>
                                                                                    <?php echo $rank; ?>
                                                                                    <?php if($row['randesc'] == $rank) {echo ' (current rank)'; } ?>
                                                                                    <?php if(trim($row['rprom' . ($i-1)]) == $rank) echo ' (Evaluator Recommended)'; ?>
                                                                    ...
                                                                    <tr>
                                                                        <th colspan="2"> <span id="rankwarning" <?php echo $nextrank; ?> style="color: red; <?php echo in_array($row['promote'], [$nextrank, 'NOT FOR PROMOTION']) ? 'display:none; ' : ''; ?>">You have skipped a level based on the organization's promotion level of hierarchy. Please click CONTINUE to proceed with the recommendation.</span></th>
                                                                    </tr>
                                                                    <tr>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php
                                                                ...
                                                                foreach ($ranks as $rank) {
                                                                    ...
                                                                    <option value="<?php echo $rank; ?>">
                                                                        <?php if(strtolower($row['randesc']) == strtolower($rank)) {echo '(current rank)'; } ?>
                                                                        <?php if(trim($row['rprom' . ($i-1)]) == $rank) echo 'Approver Recommendation'; ?>
                                                                        <?php if($rank == $ranks[array_search($row['randesc'], $ranks) + 1]) echo '(System recommended)'; ?>
                                                            ...
                                                            <?php if($row['rstat'.$i] != 1) : ?>
                                                            <input type="text" id="promoteto" class="promotion" name="promotion" /*list="ranks"*/ value="<?php if(!empty(trim($row['rprom'.$i]))) echo $row['promote']; ?>" autocomplete="off" onChange="" onClick="this.value = '';" data-promote="<?php echo $row['randesc']; ?>" style="width: 350px !important">
                                                            <?php else: ?>
                                                                <input type="text" id="" class="" name="" value="<?php if(!empty(trim($row['rprom'.$i]))) echo $row['promote']; ?>" autocomplete="off"  data-promote="<?php echo $row['randesc']; ?>" style="width: 350px !important" disabled>

                                                            <?php endif; ?>

                                                            <input type="hidden" id="currentrank" value="<?php echo $row['randesc']; ?>">
                                                            <br><br>
                                                            Current rank is <b>"<?php echo $row['randesc']; ?>" </b>    
                                                            <br>
                                                            <?php if($row['rprom' . ($i-1)]  == $ranks[array_search($row['randesc'], $ranks) + 1]) : ?>
                                                                Evaluator and System recommends for promotion to <b> "<?php echo $row['rprom' . ($i-1)]; ?>" </b>
                                                            <?php else: ?>
                                                                <?php if($row['rprom' . ($i-1)]  != $row['randesc'] && !empty(trim($row['rprom' . ($i-1)]))) : ?>
                                                                Evaluator recommends for promotion to <b>"<?php echo $row['rprom' . ($i-1)]; ?>"</b> 
                                                                <br>
                                                                <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" id="promotetoPos" class="promotetoPos" name="promotetoPos" value="<?php echo $row['promotePos']; ?>" style="width: 350px !important" <?php echo ($row['rstat'.$i] != 1) ? '' : 'disabled'; ?>>
                                                            <br><br>
