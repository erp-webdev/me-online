                        ...
                        <?php if(count($checkWResults) > 0) { ?>
                                    ...
                                    <p style="float:left;"> Comments: </p>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea name="wrp3resachieve[]" class="checker" cols="80" rows="2"><?php echo $row['wresachieve'] ?></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 100px">Comments: </td>
                                                <td>
                                                    <textarea name="wrp3remarks[]" class="checker" cols="80" rows="2"><?php echo $row['wremarks'] ?></textarea>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function(){
                                       ...
                                       function fnAlltotal(){
                                             ...
                                             if(promote != randesc && $.trim(promote) != '' && promote != undefined && promote != 'NOT FOR PROMOTION'){
                                            ...
                                            if(rank_current != rank_promotion && rank_promotion != '' && rank_promotion != undefined && rank_promotion != 'NOT FOR PROMOTION'){
                            ...
                            <div style="border:1px solid #fff;padding-left:5px;padding-right:5px;width:98%;">
                                ...
                                <div class="work-result-wrapper">
                                    ...
                                    <textarea name="pccremarks[]" id="" cols="90" rows="3" class="<?php if($row['grating'] != 3){ ?>checker<?php } ?>"><?php echo $row['remarks'] ?></textarea>
                                ...
                                function fnAlltotalpcc(){
                                      ...
                                      var sys_gen_inc = (computed_score / 5 ) * (reg_increase);
                                      if(promote != randesc && $.trim(promote) != '' && promote != undefined && promotion != 'NOT FOR PROMOTION'){
                                         sys_gen_inc = (computed_score / 5 ) * (pro_increase);
                                      }
                                       ...
                                       <?php $countcswr = 1; foreach ($checksetwr as $row) { ?>
                                          ...
                                          <p> Meausurement of accomplishment: </p>
                                              <!-- <input name="setmoa[]" type="text" value="<?php echo $row['MOA'] ?>" style="margin-top:-8px;width:89%;" class="smltxtbox checker"> -->
                                                ...
                                                <textarea name="setmoa[]" class="checker" style="width:80%;"><?php echo $row['MOA']; ?></textarea>
                            ...
                            <script type="text/javascript">
                             ...
                             <?php foreach($checkEvaluation AS $row) { ?>
                                ...
                                <table style="width:99%;">
                                    <tr style="background-color:#fff;">
                                        <td colspan="7" style="text-align:center;font-weight:bold;color:#A70606;"> Kindly inform the HR for the Employee Conduct/Memo, Attendance and Punctuality, Customer Experience and Training Scores </td>
                                    </tr>
                                </table>
                                <?php } ?>
                            <?php } ?>
                            ...
                            <br />
                                ...
                                <h3 style="">
                                    ...
                                    <span id="sys_gen_inc"><?php
                                        ...
                                        if($checkEvaluation[0]['randesc'] != $checkEvaluation[0]['promote'] && !empty(trim($checkEvaluation[0]['promote'])) && trim($checkEvaluation[0]['promote']) != 'NOT FOR PROMOTION')
                                        ...
                                        <div id="paf_data" style="color: black">
                                            ...
                                            <?php 
                                                $ranks = [
                                                    ...
                                                    if($checkEvaluation[0]['DBNAME'] == 'MCTI'){
                                                        $ranks = [
                                                            'Rank and File 1',
                                                            'Rank and File 2',
                                                            'Senior Rank and File 1',
                                            ...
                                            <table class="tdataform2 rightmargin margintop10 vsmalltext" width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th style="vertical-align:top;"><?php echo $checkEvaluation[0]['randesc']; ?></th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align:top;">
                                                            <b><?php   
                                                                    ...
                                                                    foreach($ranks as $rank):
                                                                        ...
                                                                        if($rank == $checkEvaluation[0]['randesc'])
                                                                            $next = true;

                                                                    endforeach; ?>
                                                            </b><br>
                                                            <span>Based on the Organizational Levels Hierarchy</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top; text-align:right">Recommended Level by Evaluator/s</td>
                                                        <th style="vertical-align:top;"><?php echo empty(trim($checkEvaluation[0]['rprom' . ($_GET['sub']-1)])) ? 'No recommendation' : $checkEvaluation[0]['rprom' . ($_GET['sub']-1)]; ?></th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th style="vertical-align:top;">
                                                            <select id="finalrank" class="txtbox width95per">
                                                                ...
                                                                <option value="<?php echo $rank; ?>" <?php echo $checkEvaluation[0]['promote'] == $rank ? 'selected' : ''; ?>>
                                                                    <?php echo $rank; ?>
                                                                    <?php if($checkEvaluation[0]['randesc'] == $rank) {echo ' (current rank)'; } ?>
                                                                    <?php if(trim($checkEvaluation[0]['rprom' . ($_GET['sub']-1)]) == $rank) echo ' (Evaluator Recommended)'; ?>
                                                                    <?php if($rank == $ranks[array_search($checkEvaluation[0]['randesc'], $ranks) + 1]) echo ' (System recommended)'; ?>
                                                    ...
                                                    <tr>
                                                        <th colspan="2"> <span id="rankwarning" <?php echo $nextrank; ?> style="color: red; <?php echo in_array($checkEvaluation[0]['promote'], [$nextrank, 'NOT FOR PROMOTION']) ? 'display:none; ' : ''; ?>">You have skipped a level based on the organization's promotion level of hierarchy. Please click CONTINUE to proceed with the recommendation.</span></th>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <option value="<?php echo $rank ?>">
                                                    <?php
                                                        ...
                                                        echo $txt;
                                                        $i = false;
                                                        }elseif($checkEvaluation[0]['rprom' . ($_GET['sub']-1)] == $rank){
                                                            echo "(evaluators's recommendations)";
                                                        }
                                            ...
                                            <input type="text" class="promotion" id="promotion" name="promotion" value="<?php if(!empty(trim($checkEvaluation[0]['rprom'.$_GET['sub']]))) echo $checkEvaluation[0]['promote']; ?>" /*list="ranks"*/ autocomplete="off" onChange="fnAlltotalpcc()" onclick="this.value = '';" data-promote="<?php echo $checkEvaluation[0]['randesc']; ?>" style="width: 350px !important" >

                                            <input type="hidden" id="currentrank" value="<?php echo $checkEvaluation[0]['randesc']; ?>">

                                            <br><br>
                                            Current rank is <b>"<?php echo $checkEvaluation[0]['randesc']; ?>" </b>
                                            <br>
                                            <?php if($checkEvaluation[0]['rprom' . ($_GET['sub'] - 1)]  == $ranks[array_search($checkEvaluation[0]['randesc'], $ranks) + 1]) : ?>
                                                Evaluator and System recommends for promotion to <br><b> "<?php echo $checkEvaluation[0]['rprom' . ($_GET['sub'] - 1)]; ?>" </b>
                                            <?php else: ?>
                                                <?php if($checkEvaluation[0]['rprom' . ($_GET['sub'] - 1)]  != $checkEvaluation[0]['randesc'] && !empty(trim($checkEvaluation[0]['rprom' . ($_GET['sub'] - 1)]))) : ?>
                                                Evaluator recommends for promotion to <b>"<?php echo $checkEvaluation[0]['rprom' . ($_GET['sub'] - 1)]; ?>"</b> 
                                                <br>
                                                <?php endif; ?>
                                ...
                                <script type="text/javascript">
                                    ...
                                    $('#finalrank').on('change', function(){
                                        if($(this).val() != '<?php echo $checkEvaluation[0]['randesc']; ?>' && $(this).val() != '<?php echo $nextrank; ?>' && $(this).val() != 'NOT FOR PROMOTION'){
                                            $("#rankwarning").show();
                                        }else{
                                            $("#rankwarning").hide();
                                        }
                    ...
                    <?php } else { ?>
                        ...
                        <?php if(count($checkWResults) > 0) { ?>
                            ...
                            <div style="border:1px solid #fff;padding-left:5px;width:98.6%;">
                                ...
                                <h3 style=""><strong>Equivalent system generated percentage increase: </strong>
                                    <input type="hidden" id="computed_score" value="<?php echo $checkEvaluation[0]['computed']; ?>">
                                    <input type="hidden" id="reg_increase" value="<?php echo $appraisal[0]['Increase']; ?>">
                                    <input type="hidden" id="pro_increase" value="<?php echo $appraisal[0]['Proincrease']; ?>">
                                    <span id="sys_gen_inc">
                                ...
                                <p><strong>Final Recommendation;</strong> please fill up your desired recommendations below.  
                                <!-- This will override system generated percentage for salary increase. -->
                            </p>
                                <table>
                                    <tr>
