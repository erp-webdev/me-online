...
<script>
    ...
    let apiUrl = 'https://dev.megaworldcorp.com:8081/peoplesedge/api/pmsv1/my-evaluations?EmpID=<?php echo $profile_idnum; ?>&EmpDB=<?php echo $profile_dbname; ?>&GroupID=<?php echo $_GET['GroupID']; ?>';
    axios.get(apiUrl)
        .then(response => {
