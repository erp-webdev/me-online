        ...
        <div style="overflow-x:none;overflow-y:scroll;max-height:514px;padding-bottom:5px;">
                ...
                <tr>
                    ...
                    <td style="text-align:center;width:25px;">
                        ...
                        <select name="caAp[]" class="width25 smltxtbox actp<?php echo $row['id']; ?> checker" >
                            <option <?php if ($row['ActProficiency'] == NULL) { ?>selected="selected"<?php } ?> value="">0</option>
        ...
        <?php } else { ?>
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <select name="caAp[]" class="width25 smltxtbox actp<?php echo $row['id']; ?> checker" required />
    ...
    <?php } ?>
            ...
            <table id="gcutep" border="0" cellspacing="0" class="tdata" style="width:99%;">
                ...
                <?php } else { ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <input type="radio" value="5" checked="checked" name="g2Rad1" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="4" checked="checked" name="g2Rad1" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="3" checked="checked" name="g2Rad1" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="2" checked="checked" name="g2Rad1" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="1" checked="checked" name="g2Rad1" required>
                            </td>
                            <td style="text-align:center;">
                      ...
                      <!--   <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <?php if($row['tscore'] == "5"){ ?><input type="radio" value="5" checked="checked" name="g2Rad1" required><?php } else { ?><input type="radio" value="5" disabled><?php } ?>
                            </td>
                            <td style="text-align:center;">
                                <?php if($row['tscore'] == "4"){ ?><input type="radio" value="4" checked="checked" name="g2Rad1" required><?php } else { ?><input type="radio" value="4" disabled><?php } ?>
                            </td>
                            <td style="text-align:center;">
                                <?php if($row['tscore'] == "3"){ ?><input type="radio" value="3" checked="checked" name="g2Rad1" required><?php } else { ?><input type="radio" value="3" disabled><?php } ?>
                            </td>
                            <td style="text-align:center;">
                                <?php if($row['tscore'] == "2"){ ?><input type="radio" value="2" checked="checked" name="g2Rad1" required><?php } else { ?><input type="radio" value="2" disabled><?php } ?>
                            </td>
                            <td style="text-align:center;">
                                <?php if($row['tscore'] == "1"){ ?><input type="radio" value="1" checked="checked" name="g2Rad1" required><?php } else { ?><input type="radio" value="1" disabled><?php } ?>
                            </td>
                            <td style="text-align:center;">
                                <input type="text" name="g2Comments1[]" style="width:96.5%;" class="smltxtbox" />
                            </td>
                       ...
                       <!--  <tr>
                            ...
                            <td style="text-align:center;">
                                <?php if($row['S5Score'] == "5"){ ?><input type="radio" value="5" checked="checked" name="g2Rad2" required><?php } else { ?><input type="radio" value="5" disabled><?php } ?>
                            </td>
                            <td style="text-align:center;">
                    ...
                    <?php 
                        ...
                        <tr>
                            <td style="text-align:center;">
                               <input type="text" class="smltxtbox checker" name="g2Title<?php echo $i; ?>[]" value="<?php echo $row['Goals']; ?>" style="width:88%;" readonly required />
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="5" checked="checked" name="g2Rad<?php echo $i; ?>" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="4" checked="checked" name="g2Rad<?php echo $i; ?>" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="3" checked="checked" name="g2Rad<?php echo $i; ?>" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="2" checked="checked" name="g2Rad<?php echo $i; ?>" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="radio" value="1" checked="checked" name="g2Rad<?php echo $i; ?>" required>
                            </td>
                            <td style="text-align:center;">
                                <input type="text" name="g2Comments<?php echo $i; ?>[]" value="<?php //echo $row['Comments']; ?>" style="width:96.5%;" class="smltxtbox" />
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php } ?>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    var counter = <?php if($checkifsave == 2){ echo $counterg2 + 1; } else { echo '3'; } ?>;
            ...
            <?php foreach($evaluateRatee AS $row) { ?>
                <?php if($row['cmscore'] != NULL && $row['apscore'] != NULL){ ?>
                <?php 
                ...
                <table style="border:2px solid #fff;width:99%;">
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php $finincrease = round($ggfin / 5 * 100); echo $finincrease.'%';  ?></td>
                ...
                <table style="width:99%;">
                    <tr style="background-color:#fff;">
                        <td colspan="7" style="text-align:center;font-weight:bold;color:#A70606;"> Kindly inform the HR for the Employee Conduct/Memo and Attendance Score </td>
                    </tr>
                </table>
                <?php } ?>
            <?php } ?>
            ...
            <?php if($max1i == 1) { ?>
                <h3><strong>Equivalent system generated percentage increase: </strong> <?php echo $finincrease * .10.'%'; ?></h3>
                ...
                Promotion To: <input type="text" name="promotion" value="<?php echo $rprom1; ?>">&nbsp;&nbsp;&nbsp;
                Salary Increase: <input type="number" min="1" max="100" name="increase" value="<?php echo $rincr1; ?>">%
                <br /><br />
            <?php } else { ?>
            ...
            <textarea name="remarks" class="remarks checker" style="width:98.4%;min-height:100px;" required><?php if($checkifsave == 2) { echo $row['rcomm1']; } ?></textarea>
            <br /><br />
