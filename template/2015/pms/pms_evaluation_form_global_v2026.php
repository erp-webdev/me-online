                ...
                <div ng-show="!loading && record !== ''">
                    ...
                    <div class="print" style="overflow-x:none;overflow-y:scroll;max-height:514px;">
                        ...
                        <div ng-show="record.competencies.length == 0 || record.competencies == null">
                            <table style="width:100%;">
                                <tr style="background-color:#fff;">
                                    <td colspan="7" style="text-align:center;font-weight:bold;color:#A70606;"> Kindly inform the HR for the Part III Personal Competencies Form </td>
                                </tr>
                            </table>
                            <br />
                        </div>
                                        ...
                                        <div class="pcc-left-wrapper" style="float:left;width:100%;">
                                            <table class="tdata" cellspacing="5" style="width:100%;">
                                                ...
                                                <tr ng-repeat="next_pcc in record.competencies_next">
                                                    ...
                                                    <td>
                                                        <input type="number"
                                                            ng-model="next_pcc.Weight"
                                                            min="0" max="100"
                                                            class="smltxtbox calcp5w checker"
                                                            style="width:35px;"
                        ...
                        <table style="border:1px solid #fff;width:99.6%;">
                            <thead>
                            <tr>
                                <th style="text-align:left;width:350px;">A. HR RELATED EVALUATION - 25%</th>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;border-top:1px solid #fff;">
                                    <span ng-bind="round2(((record.TrainingScore * 5)/100) + ((record.AttendancePunctualityScore * 10)/100) + ((record.ConductMemoScore * 10)/100))"></span>
                                </td>
                            </tr>
                        </table>
                        <h4 style="text-align:center;"> Final Summary </h4>
                        <div style="width:99%;background-color:#fff;padding:2px;" ng-show="record.AttendancePunctualityScore == null || record.TrainingScore == null || record.ConductMemoScore == null">
                            <p style="text-align:center;font-weight:bold;color:#A70606;"> Kindly inform the HR for the Employee Conduct/Memo, Attendance and Punctuality, Customer Experience and Training Scores </p>
                        </div>

                        <table style="border:1px solid #fff;width:99%;" >
                            <thead>
                                <tr>
                                    <th style="text-align:left;width:350px;">B. PERFORMANCE EVALUATION - 75%</th>
                                    <th style="text-align:center;">% Value</th>
                                    <th style="text-align:center;">Rate</th>
                                    <th style="text-align:center;">Final Value</th>
                                </tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><span ng-bind="totalCompetencyWeightRating|number:2"></span></td>
                                <td style="text-align:center;"><span ng-bind="((totalCompetencyWeightRating*40)/100)|number:2"></span></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:right;font-weight:bold;">Total:</td>
                                <td style="text-align:center;border-top:1px solid #fff;"><span ng-bind="record.evaluation_score = (round2((totalCompetencyWeightRating*40)/100) +  round2((totalGoalWeightRating * 35)/100)) | number:2"></span></td>
                            </tr>

                            <tr>
                                <td style="font-weight:bold;text-align:right;">Overall Performance : </td>
                                <td style="text-align:center;"><span ng-bind="record.total_computed_score = round2(record.evaluation_score + (round2((record.TrainingScore * 5)/100)) + round2(((record.AttendancePunctualityScore * 10)/100)) + round2(((record.ConductMemoScore * 10)/100)))"></span></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                            </tr>
...
<script>
    ...
    app.controller('myCtrl', function($scope, $http,  $sce) {
        ...
        $scope.updateRecord = function(){
            ...
            $scope.record.evaluation_score = ($scope.round2(($scope.totalCompetencyWeightRating*40)/100) +  $scope.round2(($scope.totalGoalWeightRating * 35)/100));
            $scope.partHRScore = (($scope.record.TrainingScore * 5)/100) + (($scope.record.AttendancePunctualityScore * 10)/100) + (($scope.record.ConductMemoScore * 10)/100);
            ...
            $scope.record.system_increase = $scope.round2(($scope.record.total_computed_score/5) * 100 * (percentage_increase/100));
        }
