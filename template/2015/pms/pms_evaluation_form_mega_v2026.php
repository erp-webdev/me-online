            ...
            <div id='evaluation-form-wrapper'>
                ...
                <div ng-show="!loading">
                    ...
                    <div class="print" style="overflow-x:none;overflow-y:scroll;max-height:514px;">
                        ...
                        <hr>
                        <table style="border:2px solid #fff;width:99%;" ng-show="record.AttendancePunctualityScore > 0 && record.ConductMemoScore > 0">
                            <thead>
                            <tr>
                        ...
                        <table style="border:2px solid #fff;width:99%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><span ng-bind="round2((totalCompetency*35)/100)"></span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"></td>
                                <td style="text-align:right;font-weight:bold;">Total:</td>
                                <td style="text-align:center;border-top:1px solid #fff;"><span ng-bind="((totalCompetency*35/100)+(totalGoal*40/100)).toFixed(2)"></span></td>
                            </tr>
                        ...
                        <table style="width:99%;" ng-show="record.AttendancePunctualityScore == 0 || record.ConductMemoScore == 0">
                            <tr style="background-color:#fff;">
...
<script>
    ...
    app.controller('myCtrl', function($scope, $http,  $sce) {
        ...
        $scope.updateRecord = function(){
            ...
            $scope.record.evaluation_score =  (parseFloat($scope.totalCompetency.toFixed(2)) * 35/100) + (parseFloat($scope.totalGoal).toFixed(2) * 40/100);

            $scope.partHRScore = parseFloat((($scope.record.AttendancePunctualityScore * 0.1) + parseFloat($scope.record.ConductMemoScore * 0.15)).toFixed(2));
