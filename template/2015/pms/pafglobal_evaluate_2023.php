...
<b class="mediumtext lorangetext"><a href="<?php echo WEB; ?>/pms?page=eval&GroupID=<?php echo $groupid; if(isset($_GET['sub'])) echo '&sub=' . $_GET['sub']; ?>&ref=emp<?php echo $_GET['appid']; ?>"><i class="mediumtext fa fa-arrow-left" style="color:#fff;opacity:.8;"></i></a> Performance Appraisal Form - Supervisor/Rater</b><br><br>
...
<form id="frm_paf" method="post" <?php //action="?ignore-page-cache=true" ?> enctype="multipart/form-data">
    ...
    <div style="border:1px solid #fff;padding-left:5px;padding-right:5px;width:98%;">
        ...
        <script type="text/javascript">
               ...
               function fnAlltotal(){
                     ...
                     var selected_rank = $('input[name="promotion"]').val();
    ...
    <div style="border:1px solid #fff;padding-left:5px;padding-right:5px;width:98%;">
        ...
        <div class="work-result-wrapper">
            ...
            <textarea name="pccremarks[]" id="" cols="90" rows="3" class="checker"><?php echo $row['remarks'] ?></textarea>
            </div>
            <div style="clear:both;"></div>
            ...
            <?php if($checkifsave == 2) { ?>
               ...
               <?php } else { ?>
                  ...
                  <p> Measurement of accomplishment: </p>
                      ...
                      <textarea name="setmoa[]" class="checker" style="width:80%;"></textarea>
            ...
            <div id="nview" class="fview" style="display: none;">
                ...
                <div id="paf_data" style="color: black">
                    ...
                    <?php 
                            ...
                            if($evaluateRatee[0]['DBNAME'] == 'MCTI'){
                                $ranks = [
                                    'Rank and File 1',
                                    'Rank and File 2',
                                    'Senior Rank and File 1',
                    ...
                    <table class="tdataform2 rightmargin margintop10 vsmalltext" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                <th colspan="2"> <span id="rankwarning" style="color: red; <?php echo in_array(trim($evaluateRatee[0]['promote']), [$nextrank, 'NOT FOR PROMOTION', '']) ? 'display:none; ' : ''; ?>">You have skipped a level based on the organization's promotion level of hierarchy. Please click CONTINUE to proceed with the recommendation.</span></th>
                            </tr>
                            <tr>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="promotion" value="<?php echo $rprom1; ?>" /*list="ranks"*/  autocomplete="off" onclick="this.value = ''; fnAlltotalpcc()" data-promote="<?php echo $evaluateRatee[0]['randesc']; ?>" readonly  style="width:350px !important">
...
<script type="text/javascript">
    ...
    $(".closebutton").on("click", function() {
        ...
        $('input[name="promotion"]').val($("#finalrank").val());
        fnAlltotal();
    });
