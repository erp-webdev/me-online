                    ...
                    <table id="gcutep" border="0" cellspacing="0" class="tdata" style="width:99%;">
                        ...
                        <tbody id="jsgoals">
                            <tr ng-repeat="goal in record.goals">
                                <td style="vertical-align: top;"><span ng-bind="$index+1"></span></td>
                                <td style="">
                                    <textarea class="checker" cols="80" rows="3" ng-model="goal.Goals" ng-disabled="goal.id != null || goal.Goals == '8 hrs mandatory training' || is_approved" placeholder="Provide SMART Goal" ng-required="goal.Goals != '8 hrs mandatory training'" minlength="10"></textarea>
