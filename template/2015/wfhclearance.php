					...
					<div id="ldetails"  >
						<table class="tdataform" border="0" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td width="75%">
                                    <input id="wfhc_from_" type="text" name="wfhc_from" value="" class="txtbox datepickwh_" readonly /> - <input id="wfhc_to_"  type="text" name="wfhc_to_" value="" class="txtbox datepickwh_" readonly/>
                                </td>
							</tr>
                            <tr>
