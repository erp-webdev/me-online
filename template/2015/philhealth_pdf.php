<div id="myDivToPrint2">
	...
	<body style="size: Legal; font-size: 7pt; font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif">
		...
		place_text(date('m', strtotime($emp_info[0]["BirthDate"])), 147.30, 81.80, 'letter-spacing: 5.5px');
		place_text(date('d', strtotime($emp_info[0]["BirthDate"])), 157.30, 81.80, 'letter-spacing: 5.5px;');
		place_text(date('Y', strtotime($emp_info[0]["BirthDate"])), 167.30, 81.80, 'letter-spacing: 7.3px;');
