<div id="myDivToPrint2">
	...
	<body style="size: Legal; font-size: 7pt; font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif">
		...
		place_text(substr($ph_no, 0, 2), 82.5, 71.5, 'letter-spacing: 10px');
		place_text(substr($ph_no, 2, 9), 93, 71.5, 'letter-spacing: 8px');
		place_text(substr($ph_no, 11, 1), 130, 71.5, 'letter-spacing: 10px');
