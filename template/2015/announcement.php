    ...
    <!-- BODY -->
                    ...
                    <div id="floatdiv" class="floatdiv invisible">                                         
                        ...
                        <!-- CREATE MEMO - BEGIN --> 
                        <div id="aadd" class="fadd" style="display: none;">
                            <div class="closebutton cursorpoint"><i class="fa fa-times-circle fa-3x redtext"></i></div>
                            <div id="madd_title" class="robotobold cattext dbluetext">Create Announcement</div>
                        ...
                        <!-- CREATE MEMO - END -->                    
                        <!-- UPDATE MEMO - BEGIN --> 
                        <div id="aedit" class="fedit" style="display: none;">
                            <div class="closebutton cursorpoint"><i class="fa fa-times-circle fa-3x redtext"></i></div>
                            <div id="medit_title" class="robotobold cattext dbluetext">Update Announcement</div>
                            ...
                            <table class="tdataform2 rightmargin margintop10 vsmalltext" width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        ...
                                        <input type="submit" name="btnresendmemo" value="Send Announcement to Employees via Email" class="btn btnresendmemo" />
                                        <input type="hidden" name="memo_attachment" id="umemo_attachment" />
                                        <input type="hidden" name="memo_user" id="umemo_user" />
                    ...
                    <div id="mainsplashtext" class="mainsplashtext lefttalign">  
                        ...
                        <div class="rightsplashtext lefttalign">
                            <div id="mainmemo" class="mainbody lefttalign whitetext">  
                                <b class="mediumtext lorangetext">ANNOUNCEMENT</b><br><br>                                
                                ...
                                <table class="width100per">
                                    <tr>
                                        <td><span class="fa fa-search"></span> Search: 
                                            ...
                                            <input type="text" id="searchmemo" name="searchmemo" value="<?php echo $_SESSION['searchmemo'] ? $_SESSION['searchmemo'] : ''; ?>" placeholder="announcement title" class="smltxtbox" />&nbsp;
                                            <input type="button" id="btnsearchann" name="btnsearchann" value="Search" class="smlbtn btnsearchann" />
                                            <input type="button" id="btnsearchallann" name="btnsearchallann" value="View All" class="btnsearchallann smlbtn<?php if (!$_SESSION['searchmemo'] && !$_SESSION['memofrom'] && !$_SESSION['memoto']) : ?> invisible<?php endif; ?>" />                                            
                                        </td>
                                        <td class="righttalign">
                                            <?php if ($profile_level == 7 || $profile_level == 10) : ?>
                                            <input type="button" id="btnaddann" name="btnaddann" value="Create Announcement" class="btnaddann smlbtn" />
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table border="0" cellspacing="0" class="tdata width100per margintop25">
                                    ...
                                    <tr class="trdata centertalign">
                                        ...
                                        <td width="70%" class="lefttalign<?php if ($key == 0) : ?> topborder<?php endif; ?>"><span class="btnviewmemo cursorpoint bold" attribute="<?php echo $value['MemoAttach']; ?>"><?php echo $value['MemoName']; ?></span><br>Published: <?php echo date('F j, Y', strtotime($value['MemoDate'])); ?><?php if ($profile_level == 7 || $profile_level == 10) : ?><br><span class="btneditann cursorpoint" attribute="<?php echo $value['MemoID']; ?>">Edit</span> | <span class="btndelann cursorpoint" attribute="<?php echo $value['MemoID']; ?>">Delete</span><?php endif; ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                    <?php if ($pages) : ?>
                                    <tr>
