...
<div id="myDivToPrint" style="">
	...
	<div style="text-align: center; padding-top: 10px;">
		...
		<?php } elseif ($coe[0]["company"] == 'MREIT_INC') {?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;" src="<?php echo IMG_WEB; ?>/mreit_logo.png"/></p>
		...
		<?php } elseif ($coe[0]["company"] == 'Rowenta') {?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;" src="<?php echo IMG_WEB; ?>/rowenta-logo.png"/></p>
		<?php } elseif ($coe[0]["company"] == 'MEGAPARK') {?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;" src="<?php echo IMG_WEB; ?>/megapark-logo.png"/></p>
		<?php } else {?>
	...
	?>
			...
			<div style="text-align: justify;  text-justify: inter-word;">
				<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This is to certify that <b><?php echo $emp_info[0]["Salutation"]." ".strtoupper($fullname); ?></b>
				...
				<p style="padding-left: 50px; padding-right: 50px;">This is to further certify that <?php echo $emp_info[0]["salutation"]." ".strtoupper($fullname); ?> shall be on leave from <b><?php echo date('F d, Y', strtotime($start_date))." to ".date('F d, Y', strtotime($end_date)); ?>
			...
			<div style="text-align: justify;  text-justify: inter-word;">
				<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This certifies that <b><?php echo strtoupper($fullname); ?></b> is<?php if( in_array(strtolower(substr($emp_info[0]["PositionDesc"],0,1)), ['a','e','i','o','u']) ){ echo ' an '; }else{ echo ' a '; }?>
				<b><?php
				...
				<p style="padding-left: 50px; padding-right: 50px;">This also certifies that <b><?php echo strtoupper($fullname)."</b> and <b>".strtoupper($coe[0]["correction_name"]); ?>
				</b>is the same person as <?php echo strtoupper($fullname); ?>.</p>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This certifies that <b><?php echo ucwordsExcept(strtolower($fullname)); ?></b>
				<?php if($emp_info[0]["DateResigned"]){ ?>
					was employed as
				<?php }else{ ?>
					is currently employed as
				<?php } ?>
			<b><?php echo ucwordsExcept(strtolower($emp_info[0]["PositionDesc"]))."</b> by <b>".ucwordsExcept(strtolower($emp_info[0]["CompanyName"]))."</b> from <b>".$emp_info[0]["HireDate"]; ?>
			<?php if($emp_info[0]["DateResigned"]){ echo "to ".$emp_info[0]["DateResigned"]."</b>"; }else{ ?>
			up to the present.</b></p>
			<?php } ?>

			<p style="padding-left: 50px; padding-right: 50px;">This certification is being issued upon the request of <?php echo ucwordsExcept(strtolower($emp_info[0]["Salutation"]))." ".ucwordsExcept(strtolower(mb_convert_encoding($emp_info[0]["LName"], 'UTF-8', 'HTML-ENTITIES'))); ?>
			<?php
				if($coe[0]["other_reason"]){
			?>
					as a requirement for <?php echo $emp_info[0]["Gender2"]. " ".$coe[0]["other_reason"];?>.</p>
		...
		<?php
			...
			<div style="text-align: justify;  text-justify: inter-word;">
				...
				<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This certifies that <b><?php echo ucwordsExcept(strtolower($emp_info[0]["Salutation"]." ".$fullname)); ?></b>
					<?php if($emp_info[0]["DateResigned"]){ ?>
						was employed as
					<?php }else{ ?>
						is currently employed as
					<?php } ?>
				<b><?php
				echo ucwordsExcept(strtolower($emp_info[0]["PositionDesc"]))."</b> by <b>".ucwordsExcept(strtolower($emp_info[0]["CompanyName"]))."</b> from <b>".$emp_info[0]["HireDate"];
				?>
				<?php if($emp_info[0]["DateResigned"]){ echo "to ".$emp_info[0]["DateResigned"].".</b>"; }else{ ?>
				up to the present.</b></p>
				<?php } ?>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This is to certify that <b><?php echo strtoupper($fullname); ?></b> is an
			...
			<p style="padding-left: 50px; padding-right: 50px;"><?php echo ucwordsExcept(strtolower($emp_info[0]["Gender2"])); ?> current monthly compensation are as follows:</p>
			...
			<p style="padding-left: 50px; padding-right: 50px;">This document is issued upon the request of <b><?php echo $emp_info[0]["Salutation"]." ".strtoupper($fullname); ?>
			<?php if($coe[0]["other_reason"]){ ?>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This is to certify that <b><?php echo strtoupper($fullname); ?></b> is a former
			...
			<p style="padding-left: 50px; padding-right: 50px;"><?php echo ucwordsExcept(strtolower($emp_info[0]["Gender2"])); ?> last monthly compensation are as follows:</p>
			<!-- nbsp for the pdf conversion, tcpdf doesn't support inline block, and padding. TCPDF has different implementation for tables -->
	...
	<?php
		...
		?>
			&nbsp;<br />
			<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; color: #005f2f; text-align: center;">30th floor Alliance Global Tower, 36th Street corner 11th Avenue, Uptown Bonifacio, Barangay Fort Bonifacio Taguig City 1634<br /></p>
		<?php
		}
		?>
		<?php
