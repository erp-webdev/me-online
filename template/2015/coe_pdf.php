...
?>
		...
		<?php
			...
			?>
			<b><p style="padding-top: 50px; text-align: right; font-size: 12px; padding-right: 50px">THIS DOCUMENT IS PRIVATE AND CONFIDENTIAL.<br />
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			<p style="padding-top: 10px; padding-left: 50px; padding-right: 50px;">This certifies that <b><?php echo ucwords(strtolower($emp_info[0]["FullName"])); ?></b> was employed as
			<b><?php echo $emp_info[0]["PositionDesc"]."</b> under <b>".$emp_info[0]["DivisionName"]." Division</b> of <b>".$emp_info[0]["CompanyName"]."</b> since <b>".$emp_info[0]["HireDate"]; ?>
			<?php if($emp_info[0]["DateResigned"]){ echo "to ".$emp_info[0]["DateResigned"]."</b>"; }else{ ?>
			up to the present.</b></p>
			<?php } ?>
