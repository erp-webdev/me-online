<div id="myDivToPrint" style="height: 750px;">
	...
	?>
			...
			<div style="text-align: justify;  text-justify: inter-word;">
				...
				as a requirment for <?php echo $emp_info[0]["Gender2"]?> Employee Compensation Application. <?php echo $emp_info[0]["Gender"]?> last reported for work on <?php echo date('d M Y', strtotime($coe[0]["other_reason"])); ?>.</p>
