<div id="myDivToPrint" style="">
	...
	<div style="text-align: center; padding-top: 10px;">
		...
		<?php if ($coe[0]["company"] == 'GLOBAL01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;" src="<?php echo IMG_WEB; ?>/gl_coe.png" />
			</p>
		<?php } elseif ($coe[0]["company"] == 'LGMI01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/lgmi_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'SIRUS') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/sirus_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'MEGA01') { ?>
			<p><img src="<?php echo IMG_WEB; ?>/coe/mega_letter_head.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'TOWN01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '200px' : '250px'; ?>;"
					src="<?php echo IMG_WEB; ?>/townsquare_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'NCCAI') { ?>
			<!--  -->
			<p><img style="width: <?php echo $send_pdf ? '200px' : '250px'; ?>;"
					src="<?php echo IMG_WEB; ?>/nccai_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'FCI01') { ?>
			<!-- NOT INCLUDED -->
			<p><img style="width: <?php echo $send_pdf ? '100px' : '150px'; ?>;"
					src="<?php echo IMG_WEB; ?>/firstcentro_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'CITYLINK01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/citylink_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'ECC02') { ?>
			<!--  -->
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/ecinema_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'ECOC01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/ecoc_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'ERA01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/erex_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'LUCK01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/lctm_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'LFI01') { ?>
			<!--  -->
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/lafuerza_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'MLI01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;" src="<?php echo IMG_WEB; ?>/mli_coe.png" />
			</p>
		<?php } elseif ($coe[0]["company"] == 'MCTI') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/mcti_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'SUNT01') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/suntrust_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'ASIAAPMI') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/asiaapmi_coe.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'MREIT_INC') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/mreit_logo.png" /></p>

		<?php } elseif ($coe[0]["company"] == 'MREIT_PMI') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/mreit_logo.png" /></p>

		<?php } elseif ($coe[0]["company"] == 'MREIT_FMI') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/mreit_logo.png" /></p>

		<?php } elseif ($coe[0]["company"] == 'Rowenta') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/rowenta-logo.png" /></p>
		<?php } elseif ($coe[0]["company"] == 'MEGAPARK') { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/megapark-logo.png" /></p>
		<?php } else { ?>
			<p><img style="width: <?php echo $send_pdf ? '150px' : '200px'; ?>;"
					src="<?php echo IMG_WEB; ?>/blank_coe.png" /></p>
		<?php } ?>
	</div>
	&nbsp;
	...
	$companies = [
		...
		'ASIAAPMI' => '6/F One World Square, Upper McKinley Road, Taguig City, NCR, Philippines, 1630',
	...
	$fullname = utf8_encode($emp_info[0]["FullName"]);
	...
	if ($coe[0]["type"] == "COEAPPROVEDLEAVE") { // COE with Approved Leave
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This is to certify that
				<b><?php echo $emp_info[0]["Salutation"] . " " . strtoupper($fullname); ?></b>
				...
				as <b><?php echo $emp_info[0]["PositionDesc"] . " - " . $emp_info[0]["DeptDesc"] . "</b>  since <b>" . $emp_info[0]["HireDate"]; ?>
					<?php if ($emp_info[0]["DateResigned"]) {
						echo "to " . $emp_info[0]["DateResigned"] . "</b>";
					} else { ?>
						up to the present.</b>
				</p>
			<?php } ?>

			<p style="padding-left: 50px; padding-right: 50px;">This is to further certify that
				<?php echo $emp_info[0]["salutation"] . " " . strtoupper($fullname); ?> shall be on leave from
				<b><?php echo date('F d, Y', strtotime($start_date)) . " to " . date('F d, Y', strtotime($end_date)); ?>
				</b>as approved by the Management. <?php echo $emp_info[0]["Gender"]; ?> is expected to report back for work
				on <b><?php echo date('F d, Y', strtotime($return_date)); ?></b>.
			</p>
			...
			<p style="padding-left: 50px; padding-right: 50px;">This certification is being issued upon the request of
				...
				<?php if ($coe[0]["other_reason"]) { ?>
					as a requirement for <?php echo $emp_info[0]["Gender2"] . " " . $coe[0]["other_reason"]; ?>.
				</p>
			<?php } else { ?>
				for whatever legal purpose it may serve.</p>
			<?php } ?>
			<p style="padding-left: 50px; padding-right: 50px;">Given this
				<?php echo date('jS') . " day of " . date('F, Y'); ?>
				at <?php echo $companies[$emp_info[0]['CompanyID']]; ?>, Philippines.
			</p>
		</div>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This certifies that
				<b><?php echo strtoupper($fullname); ?></b>
				is<?php if (in_array(strtolower(substr($emp_info[0]["PositionDesc"], 0, 1)), ['a', 'e', 'i', 'o', 'u'])) {
					echo ' an ';
				} else {
					echo ' a ';
				} ?>
			...
			<p style="padding-left: 50px; padding-right: 50px;">This also certifies that
				<b><?php echo strtoupper($fullname) . "</b> and <b>" . strtoupper($coe[0]["correction_name"]); ?>
				</b>is the same person as <?php echo strtoupper($fullname); ?>.
			</p>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			...
			<p style="padding-left: 50px; padding-right: 50px;">Furthermore, this is to certify that
				<?php echo strtolower($emp_info[0]["Gender"]); ?> is qualified for a
				...
				<?php } ?>
				discount in the company's housing program as stated in our employee handbook.
			</p>

			<p style="padding-left: 50px; padding-right: 50px;">This certification is being issued upon the request of
				<?php echo $emp_info[0]["Salutation"] . " " . strtoupper(mb_convert_encoding($emp_info[0]["LName"], 'UTF-8', 'HTML-ENTITIES')) . "
				as a requirement for the Deed of Absolute Sale of " . $emp_info[0]["Gender2"] . " " . date('jS', mktime(0, 0, 0, 0, $coe[0]["avail_no"], 0)); ?>
				property availment under the company's housing program.
			</p>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			...
			<p style="padding-left: 50px; padding-right: 50px;">This further certifies that
				<?php echo strtolower($emp_info[0]["Gender"]); ?> has no derogatory record on file.
			</p>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			...
			if ($emp_info[0]["CompanyID"] == 'GLOBAL01' || $emp_info[0]["CompanyID"] == 'LGMI01') {
				?>
				<p style="padding-left: 50px; padding-right: 50px;">This does not certify that
					<?php echo $emp_info[0]["CompanyName"]; ?> has cleared <?php echo $emp_info[0]["Gender3"]; ?> of
					all of <?php echo $emp_info[0]["Gender2"]; ?> accountabilities with the Company.
				</p>
			<?php } ?>
		...
		<?php
	} elseif ($coe[0]["type"] == 'COESEPARATEDCOMPLETE') {
		?>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			...
			<p style="padding-left: 50px; padding-right: 50px;">This certification is being issued upon the request of
				<?php echo ucwords(strtolower($emp_info[0]["Salutation"])) . " " . mb_convert_case(mb_convert_encoding($emp_info[0]["LName"], 'UTF-8', 'HTML-ENTITIES'), MB_CASE_TITLE, 'UTF-8'); ?>
				<?php
				if ($coe[0]["other_reason"]) {
					?>
					as a requirement for <?php echo $emp_info[0]["Gender2"] . " " . $coe[0]["other_reason"]; ?>.
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			...
			<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This certifies that
				<b><?php echo strtoupper($emp_info[0]["Salutation"] . " " . $fullname); ?></b>
				<?php if ($emp_info[0]["DateResigned"]) { ?>
					was employed as
				<?php } else { ?>
					is currently employed as
			...
			<p style="padding-left: 50px; padding-right: 50px;"> This is to further certify that
				<?php echo strtolower($emp_info[0]["Gender"]) ?> did not receive any advance payment from the company for
				<?php echo $emp_info[0]["Gender2"] ?> SSS <?php echo strtolower($coe[0]["category"]) ?> benefit.
			</p>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			...
			<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This certifies that
				<b><?php echo strtoupper($emp_info[0]["FullName"]); ?></b>
				<?php if ($emp_info[0]["DateResigned"]) { ?>
					was employed as
				<?php } else { ?>
					is currently employed as
			...
			<p style="padding-left: 50px; padding-right: 50px;">This certification is being issued upon the request of
				<?php echo strtoupper($emp_info[0]["Salutation"]) . " " . strtoupper(mb_convert_encoding($emp_info[0]["LName"], 'UTF-8', 'HTML-ENTITIES')); ?>
				as a requirment for <?php echo $emp_info[0]["Gender2"] ?> Employee Compensation application.
				<?php echo $emp_info[0]["Gender"] ?> last reported for work on
				<?php echo date('d F Y', strtotime($coe[0]["other_reason"])); ?>.
			</p>
		...
		<div style="text-align: justify;  text-justify: inter-word;">
			...
			<p style="padding-left: 50px; padding-right: 50px;">As
				<?php if (in_array(strtolower(substr($emp_info[0]["PositionDesc"], 0, 1)), ['a', 'e', 'i', 'o', 'u'])) {
					echo ' an ';
				} else {
					echo ' a ';
				}
				echo $emp_info[0]["PositionDesc"] . ", " . strtolower($emp_info[0]["Gender"]); ?>
				<?php if ($emp_info[0]["DateResigned"]) {
					echo "had";
				} else { ?>
					has<?php } ?> the following main responsibilities:
			</p>

			<ul style="padding-left: 100px;">
				<?php
				$tasks = array_map('urldecode', $tasks);
			...
			<p style="padding-left: 50px; padding-right: 50px;">Given this
				<?php echo date('jS') . " day of " . date('F, Y'); ?>
				at <?php echo mb_convert_encoding($companies[$emp_info[0]['CompanyID']], 'UTF-8', 'HTML-ENTITIES'); ?>,
				Philippines.
			</p>
		</div>
		<?php
			...
			<div style="text-align: justify;  text-justify: inter-word;">
				<p style="padding-left: 50px; padding-right: 50px; padding-top: 0 !important; margin-top: 0 !important;">This is to certify that
					...
					<b><?php echo $emp_info[0]["HireDate"]; ?>
						...
						</b>and presently holding a <?php echo strtolower($emp_info[0]["StatusDesc"]); ?> appointment for the
						position of <b><?php echo $emp_info[0]["PositionDesc"]; ?>.</b>
					</p>
				<?php } ?>

				<p style="padding-left: 50px; padding-right: 50px;"><?php echo ucwords(strtolower($emp_info[0]["Gender2"])); ?>
					current monthly compensation are as follows:</p>
				...
				<p style="padding-left: 50px;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Basic
						Salary</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php if (true) {
							echo number_format($emp_info[0]["MonthlyRate"], 2);
						} else {
							echo "SAMPLE";
						}
						; ?></b>
				...
				<p style="padding-left: 50px; padding-right: 50px;">In addition to the above compensation package,
					...
					13th month pay during the twelve (12) month period.
				</p>

				<p style="padding-left: 50px; padding-right: 50px;">This document is issued upon the request of
					<b><?php echo $emp_info[0]["Salutation"] . " " . strtoupper($fullname); ?>
						<?php if ($coe[0]["other_reason"]) { ?>
		...
		<?php elseif (date('Y-m-d', strtotime($DateResigned2)) <= date('Y-m-d')): ?>
			<div style="text-align: justify;  text-justify: inter-word;">
				<p style="padding-top: 15px; padding-left: 50px; padding-right: 50px;">This is to certify that
					<b><?php echo strtoupper($fullname); ?></b> is a former
					employee of <b><?php echo $emp_info[0]["CompanyName"]; ?></b> from
					<b><?php echo $emp_info[0]["HireDate"]; ?> to
						<?php echo $emp_info[0]["DateResigned"]; ?> </b> with last held position of
					<b><?php echo $emp_info[0]["PositionDesc"]; ?>.</b>
				</p>

				<p style="padding-left: 50px; padding-right: 50px;"><?php echo ucwords(strtolower($emp_info[0]["Gender2"])); ?>
					last monthly compensation are as follows:</p>
				<!-- nbsp for the pdf conversion, tcpdf doesn't support inline block, and padding. TCPDF has different implementation for tables -->
				<p style="padding-left: 50px;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Basic
						Salary</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php if (true) {
				...
				<p style="padding-left: 50px; padding-right: 50px;">This document is issued upon the request of
					...
					<?php } ?> Hence, the company hold no responsibility for any misrepresentation of facts and data enumerated
					herein.
				</p>
	...
	if ($coe[0]["type"] == 'COECOMPENSATION') {
		...
		if ($coe[0]["company"] == 'MCTI') {
			...
			if ($send_pdf) {
				?>
				<img style="width: 150px" src="<?php echo IMG_WEB; ?>/coe/coe_aflores.png" />
				<?php
			} else {
				?>
				<b>
			...
			<?php
		} elseif (in_array($coe[0]["company"], ['ASIAAPMI'])) {
			?>
	...
	<?php if (in_array($coe[0]["type"], ['COE', 'COEGOODMORAL', 'COEGOODMORAL', 'COESEPARATED', 'COENONCASHADVANCEMENT'])) { ?>
		&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />
		&nbsp;<br />&nbsp;<br />&nbsp;<br />
		<?php if ($coe[0]["type"] == 'COE' && !$send_pdf) { ?>
			&nbsp;<br />&nbsp;<br />&nbsp;<br />
			&nbsp;<br />
		<?php } elseif ($coe[0]["type"] == 'COENONCASHADVANCEMENT') { ?>
			&nbsp;<br />&nbsp;<br />&nbsp;<br />
			&nbsp;<br />
		<?php } ?>
	...
	if ((in_array($coe[0]["company"], ['GLOBAL01', 'LGMI01'])) && $coe[0]["type"] != 'COECOMPENSATION' && $coe[0]["type"] == 'COESEPARATED') {
		?>
		<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; text-align: right; padding-right: 50px"><b>THIS
				DOCUMENT IS PRIVATE AND CONFIDENTIAL.<br />
		...
		if ($send_pdf) {
			?>
			<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; text-align: right; padding-right: 50px">This is a
				system generated document. Any alteration on this document is not valid.</p>
			<?php
		}
		?>
		<?php
	...
	?>
		...
		<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; padding-left: 50px; padding-right: 50px;">Ref
			No.:<?php echo $coe[0]["ref_no"]; ?></p>

		<div id="footer" style="position:absolute !important; bottom: 50px; text-align:center; width: 100%">
			<?php
			if ((in_array($coe[0]["company"], ['LGMI01']))) {
				?>
				&nbsp;<br />
				<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; text-align: center;">20th Floor Alliance
					Global
					Tower, 36th Street, corner 11th Avenue Uptown Bonifacio Taguig City 1634 - Tels (632) 5411979 / 8946345
					<br />
					<a href="www.globalcompanies.com.ph">www.globalcompanies.com.ph</a> - Email: <a
						href="globalonehr@globalcompanies.com.ph">globalonehr@globalcompanies.com.ph</a>
				</p>
				<?php
			} elseif (($coe[0]["company"] == 'GLOBAL01')) {
				?>
				&nbsp;<br />
				<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; text-align: center;">Unit G, Ground Floor,
					331
					Building, 331 Sen. Gil Puyat Avenue, Barangay Bel-Air, Makati City 1200 - Tels (632) 5411979 / 8946345
					<br />
					<a href="www.globalcompanies.com.ph">www.globalcompanies.com.ph</a> - Email: <a
						href="globalonehr@globalcompanies.com.ph">globalonehr@globalcompanies.com.ph</a>
				</p>
				...
				?>
				&nbsp;
				<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; text-align: center;">25/F Alliance Global
					Tower,
					36th Street corner 11th Avenue Uptown Bonifacio, Taguig City 1634 <br />
				...
				?>
				&nbsp;<br />
				<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; color: #005f2f; text-align: center;">
					<?php echo mb_convert_encoding($companies[$emp_info[0]['CompanyID']], 'UTF-8', 'HTML-ENTITIES'); ?> 2000
					|
					Tels 045-963-1990<br />
					www.capitaltownpampanga.com | Email info: info@capitaltownpampanga
				</p>
				<?php
			} elseif (($coe[0]["company"] == 'ASIAAPMI')) {
				?>
				...
				?>
				&nbsp;<br />
				<p style="font-size: <?php echo $send_pdf ? '8px' : '10px'; ?>; color: #005f2f; text-align: center;">30th
					floor
					Alliance Global Tower, 36th Street corner 11th Avenue, Uptown Bonifacio, Barangay Fort Bonifacio Taguig
					City
					1634<br /></p>
				<?php
			}
			?>
			<?php
			if (($coe[0]["company"] == 'MEGA01')) {
				?>
				<p style="text-align:right; width:100%">
					<img src="<?php echo IMG_WEB; ?>/coe/mega_iso.jpg" style="position: absolute: bottom: 50px; " alt="">
					<?php
			}
			?>
			</p>
