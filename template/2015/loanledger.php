                            ...
                            <select id="loan_num" name="loan_num" class="smltxtbox">
                                <?php foreach ($loanledger_data as $key => $value) : ?>
                                    <option value="<?php echo $value['ApplyTo']; ?>"><?php echo date('Y-m-d', strtotime($value['DateGranted'])) . ' | '; ?>
                                        ...
                                        elseif ($value['OExtID'] == 'OD51') : echo $payslip_oddesc[50]["OExtDesc"];
                                        elseif ($value['OExtID'] == 'OD52') : echo $payslip_oddesc[51]["OExtDesc"];
                                        elseif ($value['OExtID'] == 'OD53') : echo $payslip_oddesc[52]["OExtDesc"];
                                        elseif ($value['OExtID'] == 'OD54') : echo $payslip_oddesc[53]["OExtDesc"];
                                        elseif ($value['OExtID'] == 'OD55') : echo $payslip_oddesc[54]["OExtDesc"];
                                        elseif ($value['OExtID'] == 'OD56') : echo $payslip_oddesc[55]["OExtDesc"];
                                        elseif ($value['OExtID'] == 'OD61') : echo $payslip_oddesc[56]["OExtDesc"];
                                        endif;
                                        ?>
                                    </option>
                                <?php endforeach; ?>
                    ...
                    <table border="0" cellspacing="0" class="tdata" style="width: 100%">
                        ...
                        ?>
                                        <tr class="trdata centertalign">
                                            ...
                                            <td><?php echo number_format($value['TotalPayable'], 2, '.', ','); ?></td>
                                            <td>&nbsp;</td>
