                    ...
                    <div id="mainsplashtext" class="mainsplashtext lefttalign">  
                        ...
                        <div class="rightsplashtext lefttalign">
                            <div id="mainnotification" class="mainbody lefttalign whitetext">  
                                <b class="mediumtext lorangetext" period="<?php echo date('Y-m-d', strtotime($expfrom[0].' '.$expfrom[1].' '.$expfrom[2].' 00:00:00')); ?>" >DAILY TIME RECORD of <?php echo $udtr_full; ?></b>&nbsp;&nbsp;&nbsp;<a href="<?php echo WEB.'/dtrman'; ?>"><button class="btn">Back</button></a><br><br>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>DTR Cut-off: 
                                            <select id="udtr_cover" name="udtr_cover" class="width250 smltxtbox">
                                                <?php foreach ($dtr_period as $key => $value) : ?>
                                                <option value="<?php echo date("Y-m-d", strtotime($value['PeriodFrom']))." ".date("Y-m-d", strtotime($value['PeriodTo'])); ?>" dfrom="<?php echo strtotime($value['PeriodFrom']); ?>" dto="<?php echo strtotime($value['PeriodTo']); ?>" posted="<?php echo $value['AttPost']; ?>" dbname="<?php echo $dbname; ?>">
                                ...
                                <div id="udtrdata" class="innerdata">
                                <table border="0" cellspacing="0" class="tdata" style="width:<?php echo $dtr_data ? ' 2400px' : ' 100%'; ?>">                                    
                                    <?php if($dtr_data) : ?>
                                        ...
                                        <tr class="trdata centertalign">
                                            ...
                                            <td><?php echo $value['ML'] ? number_format($value['ML'], 2) : '0.00'; ?></td>
                                ...
                                <input id="udtr_empid" type="hidden" name="udtr_empid" value="<?php echo $udtr_idnum; ?>" />
                                <input id="udtr_comp" type="hidden" name="udtr_comp" value="<?php echo $udtr_comp; ?>" />
                                <input id="udtr_minothours" type="hidden" name="udtr_minothours" value="<?php echo $udtr_minothours; ?>" />
