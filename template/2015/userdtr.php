                    ...
                    <div id="mainsplashtext" class="mainsplashtext lefttalign">  
                        ...
                        <div class="rightsplashtext lefttalign">
                            <div id="mainnotification" class="mainbody lefttalign whitetext">  
                                <b class="mediumtext lorangetext" period="<?php echo json_encode($dfrom); ?>" >DAILY TIME RECORD of <?php echo $udtr_full; ?></b>&nbsp;&nbsp;&nbsp;<a href="<?php echo WEB.'/dtrman'; ?>"><button class="btn">Back</button></a><br><br>
