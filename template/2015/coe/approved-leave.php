...
<p>
    This is to certify that <strong><?php echo $emp_info[0]["Salutation"]." ".strtoupper(mb_convert_encoding($emp_info[0]["FullName"], 'UTF-8', 'HTML-ENTITIES')); ?></strong> <?php echo ($emp_info[0]["DateResigned"]) ? 'was employed' : 'is currently employed'; ?> with <strong><?php echo $emp_info[0]["CompanyName"]; ?></strong> as <strong><?php echo $emp_info[0]["PositionDesc"]." - ".$emp_info[0]["DeptDesc"]."</strong>  Since <strong>".$emp_info[0]["HireDate"]; ?> </strong> <?php echo ($emp_info[0]["DateResigned"]) ? 'to ' . .$emp_info[0]["DateResigned"] : 'up to the present.'; ?>
</p>
<p>
