<!-- FOOTER -->
    ...
    <script type="text/javascript" src="<?php echo JS; ?>/bootstrap-tour/js/bootstrap-tour-standalone.min.js"></script>

    <?php if($profile_idnum == '2016-06-0457') : ?>
    <script type="text/javascript" src="<?php echo JS; ?>/bootstrap-tour/pms-tour-2023.js"></script>
    <?php endif; ?>
  </body>
</html>
