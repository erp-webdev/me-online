...
<div id="mainsplashtext" class="mainsplashtext lefttalign">  
    ...
    <div class="rightsplashtext lefttalign">
        <div id="mainapprovers" class="mainbody lefttalign whitetext">  
            ...
            <div id="empdata">
                <table border="0" cellspacing="0" class="accesstable tdata width100per">
                    <?php if ($acman_data) : ?>
                    <tr>
                        <th>EmpID</th>
                        <th>Name</th>
                    ...
                    <tr class="cursorpoint trdata centertalign whitetext" >
                        <td><?php echo $value['EmpID']; ?></td>
                        <td><?php echo $value['Fullname']; ?></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="dtr" value="dtr" id="dtr" <?php if($value['dtr']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="payslip" value="payslip" id="payslip" <?php if($value['payslip']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="requests" value="request" id="requests" <?php if($value['request']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="approvers" value="approvers" id="approvers" <?php if($value['approvers']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="activities" value="activities" id="activities" <?php if($value['activities']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="memo" value="memo" id="memo" <?php if($value['memo']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="ads" value="ads" id="ads" <?php if($value['ads']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="bday" value="birthday" id="bday" <?php if($value['birthday']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="forms" value="forms" id="forms" <?php if($value['forms']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="wfh" value="wfh" id="wfh" <?php if($value['wfh']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="access" value="access" id="access" <?php if($value['access']) echo'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" attribute2="<?php echo ($value['EmpID']); ?>" attribute3="<?php echo ($value['CompanyDB']); ?>" attribute4="<?php echo ($value['EmpIDDB']); ?>" class="actoggle" name="updates" value="updates" id="updates" <?php if($value['updates']) echo'checked'; ?>></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php if ($pages) : ?>
                    <tr>
...
<script>
    (function ($) {
     ...
     $(document).ready(function(){
        $('.accesstable').rotateTableCellContent();
    });
</script>
<script type="text/javascript">
    $(function() {	
        ...
        $(".actoggle").on("click", function() {	
            ...
            empiddb = $(this).attr('attribute4');

            pstoggleobj = $(this);

            $.ajax(
            {
                url: "<?php echo WEB; ?>/lib/requests/accessman_request.php?sec=actoggle",
                data: "toggleval=" + toggleval + "&empid=" + empid + "&companydb=" + dbname+ "&empiddb=" + empiddb,
                type: "POST",
                complete: function(){
                    $("#loading").hide();
                },
