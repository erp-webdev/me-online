            ...
            <div id="empdata">
                <table border="0" cellspacing="0" class="yourtableclass tdata width100per">
                    ...
                    <tr class="cursorpoint trdata centertalign whitetext" attribute="<?php echo md5($value['EmpID']); ?>">
                        ...
                        <td style="text-align: left"><input type="checkbox" name="payslip" id="payslip" <?php ($value['Form'] == "payslip") echo 'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" name="requests" id="requests" <?php ($value['Form'] == "requests") echo 'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" name="approvers" id="approvers" <?php ($value['Form'] == "approvers") echo 'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" name="activities" id="activities" <?php ($value['Form'] == "activities") echo 'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" name="memo" id="memo" <?php ($value['Form'] == "memo") echo 'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" name="ads" id="ads" <?php ($value['Form'] == "ads") echo 'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" name="bday" id="bday" <?php ($value['Form'] == "bday") echo 'checked'; ?>></td>
                        <td style="text-align: left"><input type="checkbox" name="access" id="access" <?php ($value['Form'] == "access") echo 'checked'; ?>></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php if ($pages) : ?>
                    <tr>
