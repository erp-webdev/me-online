                        ...
                        <?php if (in_array($profile_dbname, ['MEGAWORLD', 'MLI', 'GL', 'MCTI'])) : ?><span class="spanred">NEW!</span><?php if ($section != "forms") { ?><a href="<?php echo WEB; ?>/forms" onclick="clickAndDisable(this);"><?php } ?><div<?php if ($section == "forms") { ?> class="dselected"<?php } ?>>Forms</div><?php if ($section != "forms") { ?></a><?php } ?><?php endif; ?>
...
<!-- 
                        ...
                        <?php if ($section != "dtrman") { ?>
                            ...
                            <?php if ($accessman->hasAccess($profile_idnum, $profile_comp, $profile_dbname, 'dtr') ) echo 'System &amp; '; ?>
                        ...
                        <a href="<?php echo WEB; ?>/pms" onclick="clickAndDisable(this);"><div<?php if (($section == "paf")||($section == "pafevaluate")||($section == "pafview")) { ?> class="dselected"<?php } ?>>Performance Management</div></a>
                        <?php endif; ?>
