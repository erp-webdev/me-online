			...
			?></a><?php
			 ...
			 ?>
                        ...
                        <?php if ($section != "directory") { ?><a href="<?php echo WEB; ?>/directory" onclick="clickAndDisable(this);"><?php } ?><div<?php if ($section == "directory") { ?> class="dselected"<?php } ?>>Uptown Directory</div><?php if ($section != "directory") { ?></a><?php } ?>
                        ...
                        <div class="appsubmenu downshadow" style="display: none; z-index: 200;">
                            ...
                            if ($wh_app && false) : ?><a href="<?php echo WEB; ?>/wfh" onclick="clickAndDisable(this);"><div<?php if ($section == "wfh") { ?> class="dselected"<?php } ?>>Work From Home</div></a><?php endif; ?>
