			...
			if(in_array($profile_dbname, [ 'CITYLINK', 'ECOC', 'ECINEMA', 'EREX', 'LAFUERZA', 'LCTM', 'GL', 'MEGAWORLD', 'MLI', 'NCCAI', 'SIRUS', 'SUNTRUST', 'TOWNSQUARE'])){
			 ...
			 ?>
                        ...
                        <?php if ($section != "payslip") { ?><a href="<?php echo WEB; ?>/payslip" id="payslipclick" onclick="clickAndDisable(this);"><?php } ?><div<?php if ($section == "payslip") { ?> class="dselected"<?php } ?>>Payslip</div><?php if ($section != "payslip") { ?></a><?php } ?>
                        <?php endif; ?>
                        <?php endif; ?>
