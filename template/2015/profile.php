                                    ...
                                    <div id="tabs">
                                        ...
                                        <table cellpadding="5" cellspacing="0" class="tdataform2" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td><span class="lorangetext">*</span> Mobile No.<br/><input attribute="Mobile No." type="text" name="MobileNumber" size="20" id="MobileNumber" class="txtbox" value="<?php echo $emp_data['MobileNumber']; ?>" data-inputmask="'mask': '9999 999 9999'"></td>
                                            </tr>
                                        </table><br>
                                        <table cellpadding="5" cellspacing="0" class="tdataform2" style="width: 100%;">
                                            <tr>
