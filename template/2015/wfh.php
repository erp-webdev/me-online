				...
				<div id="mainsplashtext" class="mainsplashtext lefttalign">
					...
					<div class="rightsplashtext lefttalign">
						<div id="mainwfh" class="mainbody lefttalign whitetext">
							...
							border: 2px solid rgb(156, 0, 6); height: auto; display: block;">Your have until <?php echo date('Y-m-d', $wfh_user[0]["end_date"]); ?> to file your Work from Home Application.
							</div>
							<?php } ?>
