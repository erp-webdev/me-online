																	...
																	<table>
																		<tr ng-repeat="activity in wfh_day.ACTIVITIES">
																			<td style="border-bottom: 0px; margin: 0; padding: 0" >
																				...
																				<input type="text" ng-click="timePick($this.attribute1)" attribute1="{{wfh_day.DTR}}" readonly title="Start Time: eg. 8:00" timepicker class="txtbox width55 wfh_time{{ $parent.$index+1 }} timepick_angular" ng-model="wfh_days[$parent.$index].ACTIVITIES[$index].start_time" required>
																				<input type="text" ng-click="timePick($this.attribute1)" attribute1="{{wfh_day.DTR}}" readonly title="End Time: eg. 9:00" timepicker class="txtbox width55 wfh_time{{ $parent.$index+1 }} timepick_angular" ng-model="wfh_days[$parent.$index].ACTIVITIES[$index].end_time" required>
																			</td>
...
<script>
	...
	$(document).ready(function () {
		...
		wfh_app.controller('WFHController', function WFHController($scope){
			...
			$scope.timePick = function($element){
				alert($element);
			}
