																	...
																	<table>
																		<tr ng-repeat="activity in wfh_day.ACTIVITIES">
																			<td style="border-bottom: 0px; margin: 0; padding: 0" >
																				...
																				<input type="text" readonly title="Start Time: eg. 8:00" timepicker class="txtbox width55 wfh_time{{ $parent.$index+1 }}" ng-model="wfh_days[$parent.$index].ACTIVITIES[$index].start_time" required>
																				<input type="text" readonly title="End Time: eg. 9:00" timepicker class="txtbox width55 wfh_time{{ $parent.$index+1 }}" ng-model="wfh_days[$parent.$index].ACTIVITIES[$index].end_time" required>
																			</td>
