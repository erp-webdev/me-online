																		...
																		<td class="centertalign" >
																			...
																			<table>
																				<tr ng-repeat="activity in wfh_activity<?php echo $key; ?>">
																					...
																					<td style="border-bottom: 0px; margin: 0; padding: 0" width="150px"><textarea class="txtarea" name="" id="" cols="40" rows="1" ng-model="wfh_activity<?php echo $key; ?>[$index].act" ng-click="check()"></textarea></td>
