														...
														<table width="100%" class="tdata vsmalltext" border="0" cellspacing="0">
															...
															<tr ng-repeat="wfh_day in wfh_days" id="tr{{ $index+1 }}">
																...
																<td >
																	...
																	<span>&nbsp;</span>
																	<span ng-show="activity.CREDIT > 8" style="color: yellow">*You're credit hours exceeds the allowed maximum daily worked hours. This will be subject for further approval.</span>
																</td>
															</tr>
														</table>
