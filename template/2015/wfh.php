																		...
																		<td class="centertalign" >
																			...
																			<table ng-app="WFHApp" ng-controller="WFHController">
																				<tr ng-repeat="activity in wfh_activity<?php echo $key ?>">
																					...
																					<td style="border-bottom: 0px; margin: 0; padding: 0" width="30px"><button style="" type="button" class="smlbtn" ng-show="$index == wfh_activity<?php echo $key ?>.length" ng-click="addItem(wfh_activity<?php echo $key ?>)">Add</button></td>
																				</tr>
