									...
									<div id="ldetails"  ng-app="WFHApp" ng-controller="WFHController">
										<table class="tdataform" border="0" cellspacing="0">
											<tr>
												...
												<td width="85%"><input id="wfh_from_" type="text" name="wfh_from" class="txtbox datepickwh" readonly ng-model="wfh_from"/> - <input id="wfh_to_" type="text" name="wfh_to" class="txtbox datepickwh" readonly ng-model="wfh_to"/></td>
											</tr>
											<tr>
...
<script>
	...
	$(document).ready(function () {
		...
		wfh_app.controller('WFHController', function WFHController($scope){
			...
			$scope.wfh_from.setDate($scope.wfh_from.getDate()-1).toISOString().split("T")[0];

			$scope.wfh_to = new Date().toISOString().split("T")[0];
			$scope.wfh_to = new Date(angular.copy($scope.wfh_to));
			$scope.wfh_to.setDate($scope.wfh_to.getDate()-1).toISOString().split("T")[0];
