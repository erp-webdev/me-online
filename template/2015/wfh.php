																			...
																			<table>
																				<tr ng-repeat="activity in wfh_activity<?php echo $key; ?>">
																					<td style="border-bottom: 0px; margin: 0; padding: 0" width="30px">
																						<input type="text" class="txtbox width100 " ng-model="wfh_activity<?php echo $key; ?>[$index].time">
																					</td>
