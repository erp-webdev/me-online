...
$(function() {
	...
	$(document).ready(function() {
		$('.wfhshow').click(function() {
			...
			var new_row = "<tr><td>&nbsp;</td><td><input type='text' name='TimeIn["+arrayid+"]'></td><td><input type='text' name='TimeOut["+arrayid+"]'></td><td><input type='text' name='Activities["+arrayid+"]'></td><td><input class='btn wfhremove' onClick="alert($(this).attr('attribute1'));" attribute1='"+arrayid+"' type='button' name='wfhshow' value='Remove' style='background-color: #EA171F;' /></td></tr>";
