				...
				<div id="mainsplashtext" class="mainsplashtext lefttalign">
					...
					<div class="rightsplashtext lefttalign">
						<div id="mainwfh" class="mainbody lefttalign whitetext">
							...
							border: 2px solid rgb(156, 0, 6); height: auto; display: block;">Your WFH applications from <?php echo $wfh_user[0]["start_convert"]; ?> to <?php echo $wfh_user[0]["end_convert"]; ?> can be filed until <?php echo $wfh_user[0]["end_warning"]; ?> only.
							Your access to WFH Application will be disabled after <?php echo $wfh_user[0]["end_warning"]; ?>.
							</div>
							<?php } ?>
