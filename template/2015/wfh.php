																		...
																		<td class="centertalign" ng-app="WFHApp" ng-controller="WFHController">
																			...
																			<table>
																				<tr ng-repeat="">
																					...
																					<td style="border-bottom: 0px; margin: 0; padding: 0" width="150px"><textarea  name="" id="" cols="50" rows="1"></textarea></td>
																					<td style="border-bottom: 0px; margin: 0; padding: 0" width="30px"><button class="smlbtn">Add Activity</button></td>
																				</tr>
																			</table>
																		</td>
																	</tr>
