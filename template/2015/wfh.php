			...
			$("#wfh_activity" + arrayid).prop("disabled", true);
																	...
																	<tr id="tr<?php echo $key; ?>">
																		...
																		<td class="centertalign" ng-app="WFHApp" ng-controller="WFHController">
																			...
																			<table>
																				<tr ng-repeat="">
																					<td style="border-bottom: 0px; margin: 0; padding: 0" width="50px"><input style="padding: 0px; margin: 0px" type="text" class=""></td>
																					<td style="border-bottom: 0px; margin: 0; padding: 0"><textarea  style="padding: 0px; margin: 0px" name="" id="" cols="30" rows="1"></textarea></td>
																				</tr>
																				<tr ng-repeat="">
																					<td style="border-bottom: 0px; margin: 0; padding: 0" width="50px"><input style="padding: 0px; margin: 0px" type="text" class=""></td>
																					<td style="border-bottom: 0px; margin: 0; padding: 0"><textarea  style="padding: 0px; margin: 0px" name="" id="" cols="30" rows="1"></textarea></td>
