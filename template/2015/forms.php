    ...
    <!-- BODY -->
                    ...
                    <div id="floatdiv" class="floatdiv invisible">                                        
                        ...
                        <?php if ($accessman->hasAccess($profile_idnum, $profile_comp, $profile_dbname, 'forms')) : ?>
                        <!-- CREATE MEMO - BEGIN --> 
                            ...
                            <div id="mainads" class="mainbody lefttalign whitetext">  
                                ...
                                <div class="valigntop<?php if ($form_count > 20) : ?> twocolumn2<?php endif; ?> width100per margintop25">
                                    ...
                                    <?php foreach ($form_cat as $key => $value) : ?>                            
                                        ...
                                        <li>
                                            <a href="<?php echo WEB; ?>/lib/requests/download.php?type=forms&file=<?php echo $v['download_filename']; ?>" target="_blank">
                                                <b><i class="fa <?php echo $tblsql->get_form_icon($v['download_attachtype'], $v['download_filename']); ?> fa-lg"></i>&nbsp;&nbsp;<?php echo $v['download_title']; ?></b></a><br>&nbsp;&nbsp;&nbsp;&nbsp;<?php if ($accessman->hasAccess($profile_idnum, $profile_comp, $profile_dbname, 'forms')) : ?> <a class="btneditform whitetext cursorpoint" attribute="<?php echo $v['download_id']; ?>">Edit</a> | <a class="btndelform redtext cursorpoint" attribute="<?php echo $v['download_id']; ?>">Delete</a><?php endif; ?>
