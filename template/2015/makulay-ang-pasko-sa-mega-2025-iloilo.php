<?php 
    $activity_date = $my_registration ? $my_registration[0]['activity_datestart'] : strtotime('2025-12-11'); //2025-12-11
        ...
        <head>
            ...
            <style>
                ...
                @media only screen and (max-width: 800px) {
                    ...
                    .frontpage {
                        background: url('<?php echo IMG_WEB ?>/makulay-ang-pasko-sa-mega-2025-mobile-iloilov2.webp');
                        background-size: cover; 
                ...
                <section id='reminders' class="d-flex justify-content-center sec_marg">
                    <div class="card round-box  p-5 m-3">
                        ...
                        <ul>
                            ...
                            <li>For Service Awardees: Please be at the venue on or before 2:00 PM. Upon arrival, please claim your plaque, pin, and printed photo at the Registration Area, or feel free to approach Ms. Tin Vargas.</li>
                        </ul>
                        </div>
                    </div>
                </section>
