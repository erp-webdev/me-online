    ...
    <!-- BODY -->
                    ...
                    <div id="mainsplashtext" class="mainsplashtext lefttalign">
                        ...
                        <div class="rightsplashtext lefttalign">
                            ...
                            <?php if (in_array($profile_dbname , ['GL', 'MCTI']) ) : ?>
                            <a href="<?php echo WEB; ?>/uploads/download/GLEmployeeHandbook.pdf" target="_blank" style="float: right; bottom: 250px; position: absolute; right: 29px;">
                                <img src="<?php echo WEB; ?>/images/glhandbook.png"  />
                            </a>

                            <?php else : ?>
                            <?php if ($profile_dbname != 'ECINEMA' && $profile_dbname != 'EPARKVIEW' && $profile_dbname != 'NEWTOWN' && $profile_dbname != 'LAFUERZA') : ?>
                            <a href="<?php echo WEB; ?>/uploads/download/EmployeeHandbook.pdf" target="_blank"  style="float: right; bottom: 250px; position: absolute; right: 29px;">
                            ...
                            <a href="https://tinyurl.com/yyp6m44z" target="_blank">
                                <img src="<?php echo WEB; ?>/images/CLUBACC.png" style="float: right; top: 500px; position: absolute; right: 29px;" />
                            </a>
