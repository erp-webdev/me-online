                            ...
                            <div id="mainactivity" class="mainbody lefttalign whitetext">  
                                ...
                                <table class="tdata" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="centertalign"><?php if ($value['activity_id'] > 2990) : ?><a href="<?php echo WEB; ?>/qrcode/<?php echo md5($value['registry_id']); ?>"><button class="smlbtn">QR Code</button></a><?php endif; ?><?php if ( !$value['activity_backout'] && $value['registry_status'] != 4) : ?> <a class="btndelreg cursorpoint" attribute="<?php echo $value['registry_id']; ?>"><button class="smlbtn btnred">Backout</button></a><?php endif; ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                    <?php if ($pages) : ?>
                                    <tr>
