...
<!-- BODY -->
                    ...
                    <div id="floatdiv" class="floatdiv invisible">                                        
                        ...
                        <?php if ($accessman->hasAccess($profile_idnum, $profile_comp, $profile_dbname, 'ads')) : ?>
                        <!-- CREATE ADS - BEGIN --> 
                        <div id="adadd" class="fadd" style="display: none;">
                            ...
                            <table class="tdataform2 rightmargin margintop15 vsmalltext" width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>Image</td>
                                    <td>
                                        <input type="file" name="activity_attach" id="activity_attach" class="txtbox width200" class="txtbox" /><br /><i>* must be image (jpg, jpeg, gif, png) or Video (mp4) or PDF and less than or equal 10Mb</i>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <table border="0" cellspacing="0" class="tdata width100per margintop25">
                                    ...
                                    <tr class="trdata centertalign">
                                        <td width="30%"<?php if ($key == 0) : ?> class="topborder"<?php endif; ?>><span attribute="<?php echo $value['activity_id']; ?>" attribute2="<?php echo $value['activity_title']; ?>" class="btnviewads">
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo IMG_WEB; ?>/mw.png" class="activity_img cursorpoint" /></span>
                                            <?php endif; ?>
