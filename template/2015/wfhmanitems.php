        ...
        <div id="mainapprovers" class="mainbody lefttalign whitetext">  
            ...
            <table border="0" cellspacing="0" class="tdata width100per">
                ...
                <tr class="trdata centertalign whitetext">
                    ...
                    <td>
                        <?php if($value['FormStatus'] == 'APPROVED') : ?>
                        <button type="submit" id="wfhciupdate" name="wfhciupdate" value="<?php  echo $value['SeqID'];  ?>"><i class="fa fa-save"></i></button><i class="fa fa-check-cirlce-o" style="color:green"></i>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
