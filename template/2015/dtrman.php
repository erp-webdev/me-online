                    ...
                    <div id="mainsplashtext" class="mainsplashtext lefttalign">  
                        ...
                        <div class="rightsplashtext lefttalign">
                            <div id="mainapprovers" class="mainbody lefttalign whitetext">  
                                <b class="mediumtext lorangetext"><?php if ($profile_level >= 9 ) echo 'SYSTEM and; '; ?> DTR MANAGEMENT</b><br><br>    
                                ...
                                <table border="0" cellspacing="0" class="tdata width100per">
                                    ...
                                    <tr class="trdata centertalign whitetext">
                                        ...
                                        <td class="chkps centertalign"><?php if ($chkneb) : ?><i attribute="0" attribute2="<?php echo $value['EmpID']; ?>" attribute3="<?php echo $value['DBNAME']; ?>" class="nebtoggle fa fa-check greentext cursorpoint"></i><?php else : ?><i attribute="1" attribute2="<?php echo $value['EmpID']; ?>" attribute3="<?php echo $value['DBNAME']; ?>" class="nebtoggle fa fa-times redtext cursorpoint"></i><?php endif; ?></td>
                                        <td class="chkps centertalign"><?php if ($chkaeb) : ?><i attribute="0" attribute2="<?php echo $value['EmpID']; ?>" attribute3="<?php echo $value['DBNAME']; ?>" class="aebtoggle fa fa-check greentext cursorpoint"></i><?php else : ?><i attribute="1" attribute2="<?php echo $value['EmpID']; ?>" attribute3="<?php echo $value['DBNAME']; ?>" class="aebtoggle fa fa-times redtext cursorpoint"></i><?php endif; ?></td>
                                        <?php endif; ?>
