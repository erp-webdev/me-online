                                                    ...
                                                    if ($leave_data) :
                                                        ...
                                                        ?>
                                                            <tr class="trdata">
                                                                ...
                                                                <td class="lefttalign"><?php echo $leave_bal[0]['BalanceHrs'] ? number_format($leave_bal[0]['BalanceHrs'], 2) : '0.00' ; if($usable_balance[0]['BalanceHrs'] != $leave_bal[0]['BalanceHrs'] && ($value['LeaveID'] == 'L01' || $value['LeaveID'] == 'L03')) echo " (".number_format($usable_balance[0]['BalanceHrs'], 2)." Usable)"; ?></td>
                                                                <?php else : ?>
                                                                <td class="lefttalign"><?php echo $leave_bal[0]['BalanceDays'] ? number_format($leave_bal[0]['BalanceDays'], 2) : '0.00' ; if($usable_balance[0]['BalanceHrs'] != $leave_bal[0]['BalanceHrs']  && ($value['LeaveID'] == 'L01' || $value['LeaveID'] == 'L03')) echo " (".number_format($usable_balance[0]['BalanceHrs']/8, 2)."Usable)"; ?></td>
                                                                <?php endif; ?>
