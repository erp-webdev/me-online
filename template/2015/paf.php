                    ...
                    <table class="tdata" cellspacing="0" width="100%">
                        ...
                        <tr id="group<?php echo $row['gid']; ?>">
                            ...
                            <td style="text-align:center;"><?php
                                 ...
                                 if( strpos(strtolower($row['title']), 'regularization') !== false ){
                                    echo "*";
                                }else{
                            ...
                            <td style="text-align:center;">
                                ...
                                <?php  ?>
                                <?php if($row['status'] == 'Active' && date('Y', strtotime($row['appdt'])) == date('Y')) { ?>
                                    <i class="fa fa-cog fa-spin"></i> On Going
                                <?php } elseif($row['status'] == 'Active' && date('Y') != date('Y', strtotime($row['appdt'])) ) { ?>
                                    <i class="fa fa-check"></i> Complete
                                <?php } elseif($row['status'] == 'Inactive' || date('Y', strtotime($row['appdt'])) != date('Y') ) { ?>
