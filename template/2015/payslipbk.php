                        ...
                        <div class="rightsplashtext lefttalign">
                            <div id="mainnotification" class="mainbody lefttalign whitetext">  
                                ...
                                <div class="column3 margintop25">
                                    ...
                                    <b>Cut-off Date: </b><span id='payperiod'><?php echo date("m/d/Y", strtotime($payslip_period[1]['PeriodFrom'])); ?> to <?php echo date("m/d/Y", strtotime($payslip_period[1]['PeriodTo'])); ?></span><br>
                                    <b>Pay Period: </b><span id='payto'><?php echo date("m/d/Y", strtotime($payslip_period[1]['PRTo'])); ?></span><br>
                                    ...
                                    <tr>
                                        <td width="34%" class="noborder valigntop">
                                            <table border="0" cellspacing="0" class="tdata width100per">
                                                    ...
                                                    foreach ($payslip_otmaster as $key => $value) :
                                                        foreach ($value as $k => $v) :
                                                            if ($v && $k != 'OTPay01' && $k != 'OTPay02' && $k != 'OTPay03' && $k != 'OTPay04' && $k != 'OTPay05' && $k != 'OTPay06' && $k != 'OTPay07' && $k != 'OTPay08' && $k != 'OTPay09' && $k != 'OTPay10' && $k != 'OTPay11' && $k != 'OTPay12' && $k != 'OTPay13' && $k != 'OTPay14' && $k != 'OTPay15' && $k != 'OTPay16' && $k != 'OTPay17' && $k != 'OTPay18' && $k != 'OTPay19' && $k != 'OTPay20' && $k != 'OTPay21' && $k != 'OTPay22' && $k != 'OTPay23') :
                                                                ...
                                                                echo number_format($value['OTHrs01'], 1).' hours';
                                                ...
                                                <?php
                                                    foreach ($payslip_oemaster1 as $key => $value) :
                                                        foreach ($value as $k => $v) :
                                                            if ($v) :
                                                                echo '<tr class="trdata"><td colspan="2">';
                                                                if ($k == 'OE01') : echo $payslip_oedesc[0]["OExtDesc"];
                                                                elseif ($k == 'OE02') : echo $payslip_oedesc[1]["OExtDesc"];
                                                                elseif ($k == 'OE03') : echo $payslip_oedesc[2]["OExtDesc"];
                                                                elseif ($k == 'OE04') : echo $payslip_oedesc[3]["OExtDesc"];
                                                                elseif ($k == 'OE05') : echo $payslip_oedesc[4]["OExtDesc"];
                                                                elseif ($k == 'OE06') : echo $payslip_oedesc[5]["OExtDesc"];
                                                                elseif ($k == 'OE07') : echo $payslip_oedesc[6]["OExtDesc"];
                                                                elseif ($k == 'OE08') : echo $payslip_oedesc[7]["OExtDesc"];
                                                                elseif ($k == 'OE09') : echo $payslip_oedesc[8]["OExtDesc"];
                                                                elseif ($k == 'OE10') : echo $payslip_oedesc[9]["OExtDesc"];
                                                                elseif ($k == 'OE11') : echo $payslip_oedesc[10]["OExtDesc"];
                                                                elseif ($k == 'OE12') : echo $payslip_oedesc[11]["OExtDesc"];
                                                                elseif ($k == 'OE13') : echo $payslip_oedesc[12]["OExtDesc"];
                                                                elseif ($k == 'OE14') : echo $payslip_oedesc[13]["OExtDesc"];
                                                                elseif ($k == 'OE15') : echo $payslip_oedesc[14]["OExtDesc"];
                                                                elseif ($k == 'OE16') : echo $payslip_oedesc[15]["OExtDesc"];
                                                                elseif ($k == 'OE17') : echo $payslip_oedesc[16]["OExtDesc"];
                                                                elseif ($k == 'OE18') : echo $payslip_oedesc[17]["OExtDesc"];
                                                                elseif ($k == 'OE19') : echo $payslip_oedesc[18]["OExtDesc"];
                                                                elseif ($k == 'OE20') : echo $payslip_oedesc[19]["OExtDesc"];
                                                                elseif ($k == 'OE21') : echo $payslip_oedesc[20]["OExtDesc"];
                                                                elseif ($k == 'OE22') : echo $payslip_oedesc[21]["OExtDesc"];
                                                                elseif ($k == 'OE23') : echo $payslip_oedesc[22]["OExtDesc"];
                                                                elseif ($k == 'OE24') : echo $payslip_oedesc[23]["OExtDesc"];
                                                                elseif ($k == 'OE25') : echo $payslip_oedesc[24]["OExtDesc"];
                                                                elseif ($k == 'OE26') : echo $payslip_oedesc[25]["OExtDesc"];
                                                                elseif ($k == 'OE27') : echo $payslip_oedesc[26]["OExtDesc"];
                                                                elseif ($k == 'OE28') : echo $payslip_oedesc[27]["OExtDesc"];
                                                                elseif ($k == 'OE29') : echo $payslip_oedesc[28]["OExtDesc"];
                                                                elseif ($k == 'OE30') : echo $payslip_oedesc[29]["OExtDesc"];
                                                                elseif ($k == 'OE31') : echo $payslip_oedesc[30]["OExtDesc"];
                                                                elseif ($k == 'OE32') : echo $payslip_oedesc[31]["OExtDesc"];
                                                                elseif ($k == 'OE33') : echo $payslip_oedesc[32]["OExtDesc"];
                                                                elseif ($k == 'OE34') : echo $payslip_oedesc[33]["OExtDesc"];
                                                                elseif ($k == 'OE35') : echo $payslip_oedesc[34]["OExtDesc"];
                                                                elseif ($k == 'OE36') : echo $payslip_oedesc[35]["OExtDesc"];
                                                                elseif ($k == 'OE37') : echo $payslip_oedesc[36]["OExtDesc"];
                                                                elseif ($k == 'OE38') : echo $payslip_oedesc[37]["OExtDesc"];
                                                                elseif ($k == 'OE39') : echo $payslip_oedesc[38]["OExtDesc"];
                                                                elseif ($k == 'OE40') : echo $payslip_oedesc[39]["OExtDesc"];
                                                                elseif ($k == 'OE41') : echo $payslip_oedesc[40]["OExtDesc"];
                                                                elseif ($k == 'OE42') : echo $payslip_oedesc[41]["OExtDesc"];
                                                                elseif ($k == 'OE43') : echo $payslip_oedesc[42]["OExtDesc"];
                                                                elseif ($k == 'OE44') : echo $payslip_oedesc[43]["OExtDesc"];
                                                                elseif ($k == 'OE45') : echo $payslip_oedesc[44]["OExtDesc"];
                                                                elseif ($k == 'OE46') : echo $payslip_oedesc[45]["OExtDesc"];
                                                                elseif ($k == 'OE47') : echo $payslip_oedesc[46]["OExtDesc"];
                                                                elseif ($k == 'OE48') : echo $payslip_oedesc[47]["OExtDesc"];
                                                                elseif ($k == 'OE49') : echo $payslip_oedesc[48]["OExtDesc"];
                                                                elseif ($k == 'OE50') : echo $payslip_oedesc[49]["OExtDesc"];
                                                                endif; 
                                                                echo '</td><td class="righttalign">';
                                        ...
                                        <td width="33%" class="noborder valigntop">
                                            <table border="0" cellspacing="0" class="tdata width100per">
                                                ...
                                                <?php if ($payslip_data[0]['Allowance']) : ?>
                                                <tr class="trdata">
                                                    <td>ALLOWANCE</td>
                                                    <td class="righttalign"><?php echo number_format($payslip_data[0]['Allowance'], 2); ?></td>
                                                </tr>
                                                <?php endif; ?>
                                                ...
                                                <?php
                                                    foreach ($payslip_oemaster2 as $key => $value) :
                                                        foreach ($value as $k => $v) :
                                                            if ($v) :
                                                                echo '<tr class="trdata"><td>';
                                                                if ($k == 'OE01') : echo $payslip_oedesc[0]["OExtDesc"];
                                        ...
                                        <td width="34%" class="valigntop">
                                            <table border="0" cellspacing="0" class="tdata width100per">
                                                <tr>
                                                    ...
                                                    <td class="noborder" width="33%" class="righttalign"><?php echo number_format($total_earn, 2); ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="noborder">TOTAL EARNINGS</td>
                                                    <td class="noborder righttalign"><?php echo number_format($gross_pay, 2); ?></td>
                                                </tr>
                                            </table>                                        
                                        </td>
                                            ...
                                            <table border="0" cellspacing="0" class="tdata width100per">
                                                ...
                                                <?php foreach ($leave_data as $key => $value) : ?>
                                                    ...
                                                    <tr class="trdata">
                                                        ...
                                                        <td width="35%" class="righttalign"><?php echo $leave_bal[0]['BalanceDays'] ? number_format($leave_bal[0]['BalanceDays'], 2) : '0.00' ; ?></td>
                                                    </tr>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>    
                                            </table>        
