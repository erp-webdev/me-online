                        ...
                        <div class="rightsplashtext lefttalign">
                            <div id="mainnotification" class="mainbody lefttalign whitetext">  
                                ...
                                <div class="column3 margintop25">
                                    ...
                                    <b>Cut-off Date: </b><span id='payperiod'><?php echo date("m/d/Y", strtotime($payslip_period[1]['PeriodFrom'] ? $payslip_period[1]['PeriodFrom'] : $payslip_period[0]['PeriodFrom'])); ?> to <?php echo date("m/d/Y", strtotime($payslip_period[1]['PeriodTo'] ? $payslip_period[1]['PeriodTo'] : $payslip_period[0]['PeriodTo'])); ?></span><br>
